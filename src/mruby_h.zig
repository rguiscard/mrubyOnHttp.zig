...
// mruby-4.0.0-rc2/build/host/include/mruby.h:204:24: warning: struct demoted to opaque type - has bitfield
pub const struct_mrb_context = opaque {};
pub const struct_iv_tbl_4 = opaque {};
pub const struct_RClass = opaque {};
// mruby-4.0.0-rc2/build/host/include/mruby/object.h:12:18: warning: struct demoted to opaque type - has bitfield
pub const struct_RObject = opaque {};
pub const struct_mrb_heap_page_5 = opaque {};
pub const struct_mrb_heap_region_6 = opaque {};
// mruby-4.0.0-rc2/build/host/include/mruby/object.h:12:18: warning: struct demoted to opaque type - has bitfield
pub const struct_RBasic = opaque {};
// mruby-4.0.0-rc2/build/host/include/mruby/gc.h:48:12: warning: struct demoted to opaque type - has bitfield
...
pub const struct_mrb_cache_entry = extern struct {
    ...
    mid: mrb_sym = @import("std").mem.zeroes(mrb_sym),
    m: mrb_method_t = @import("std").mem.zeroes(mrb_method_t),
};
pub const struct_mrb_sym_hash_table_7 = opaque {};
pub const struct_mrb_mt_rom_list_8 = opaque {};
pub const struct_mrb_iv_shape_9 = opaque {};
...
pub const struct_mrb_state = extern struct {
    ...
    bootstrapping: mrb_bool = @import("std").mem.zeroes(mrb_bool),
    ...
    symhash: ?*struct_mrb_sym_hash_table_7 = @import("std").mem.zeroes(?*struct_mrb_sym_hash_table_7),
    sym_pool: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    ...
    rom_mt: ?*struct_mrb_mt_rom_list_8 = @import("std").mem.zeroes(?*struct_mrb_mt_rom_list_8),
    root_shape: ?*struct_mrb_iv_shape_9 = @import("std").mem.zeroes(?*struct_mrb_iv_shape_9),
...
pub fn mrb_rfloat_value(arg_p: ?*const struct_RFloat) callconv(.c) mrb_float {
    var p = arg_p;
    _ = &p;
    return p.*.f;
}
pub fn mrb_rfloat_set(arg_p: ?*struct_RFloat, arg_f: mrb_float) callconv(.c) void {
    var p = arg_p;
    _ = &p;
    var f = arg_f;
    _ = &f;
...
// mruby-4.0.0-rc2/build/host/include/mruby.h:83:39: warning: ignoring StaticAssert declaration
...
pub fn mrb_type(arg_o: mrb_value) callconv(.c) enum_mrb_vtype {
    var o = arg_o;
    _ = &o;
    return @as(c_uint, @bitCast(if (!((o.w & ~@as(usize, @bitCast(@as(c_long, MRB_Qfalse)))) != @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) MRB_TT_FALSE else if (o.w == @as(usize, @bitCast(@as(c_long, MRB_Qtrue)))) MRB_TT_TRUE else if ((o.w & @as(usize, @bitCast(@as(c_long, (@as(c_int, 1) << @intCast(1)) - @as(c_int, 1))))) == @as(usize, @bitCast(@as(c_long, @as(c_int, 1) << @intCast(@as(c_int, 1) - @as(c_int, 1)))))) MRB_TT_INTEGER else if ((o.w & @as(usize, @bitCast(@as(c_long, @as(c_int, 31))))) == @as(usize, @bitCast(@as(c_long, @as(c_int, 28))))) MRB_TT_SYMBOL else if (o.w == @as(usize, @bitCast(@as(c_long, MRB_Qundef)))) MRB_TT_UNDEF else if (((o.w & @as(usize, @bitCast(@as(c_long, @as(c_int, 3))))) == @as(usize, @bitCast(@as(c_long, @as(c_int, 2))))) or (!(((o.w & @as(usize, @bitCast(@as(c_long, @as(c_int, 7))))) != 0) or (o.w == @as(usize, @bitCast(@as(c_long, MRB_Qnil))))) and (@as(c_int, @bitCast(mrb_val_union(o).bp.*.tt)) == MRB_TT_FLOAT))) MRB_TT_FLOAT else @as(c_int, @bitCast(mrb_val_union(o).bp.*.tt))));
}
...
pub const struct_mrb_irep_pool = extern struct {
    ...
    u: union_unnamed_12 = @import("std").mem.zeroes(union_unnamed_12),
};
pub const mrb_irep_pool = struct_mrb_irep_pool;
pub const struct_mrb_irep_debug_info_13 = opaque {};
pub const struct_mrb_irep = extern struct {
    ...
    debug_info: ?*struct_mrb_irep_debug_info_13 = @import("std").mem.zeroes(?*struct_mrb_irep_debug_info_13),
...
// mruby-4.0.0-rc2/build/host/include/mruby.h:166:11: warning: struct demoted to opaque type - has bitfield
...
pub const mrb_method_t = extern struct {
    ...
    as: union_unnamed_14 = @import("std").mem.zeroes(union_unnamed_14),
};
...
pub const MRB_OPSYM__tick: c_int = 12;
pub const MRB_SYM__a: c_int = 13;
pub const MRB_SYM__b: c_int = 14;
pub const MRB_SYM__c: c_int = 15;
pub const MRB_SYM__d: c_int = 16;
pub const MRB_SYM__e: c_int = 17;
pub const MRB_SYM__f: c_int = 18;
pub const MRB_SYM__h: c_int = 19;
pub const MRB_SYM__i: c_int = 20;
pub const MRB_SYM__k: c_int = 21;
pub const MRB_SYM__l: c_int = 22;
pub const MRB_SYM__m: c_int = 23;
pub const MRB_SYM__n: c_int = 24;
pub const MRB_SYM__o: c_int = 25;
pub const MRB_SYM__p: c_int = 26;
pub const MRB_SYM__r: c_int = 27;
pub const MRB_SYM__s: c_int = 28;
pub const MRB_SYM__t: c_int = 29;
pub const MRB_SYM__v: c_int = 30;
pub const MRB_SYM__w: c_int = 31;
pub const MRB_SYM__x: c_int = 32;
pub const MRB_SYM__y: c_int = 33;
pub const MRB_OPSYM__or: c_int = 34;
pub const MRB_OPSYM__neg: c_int = 35;
pub const MRB_OPSYM__neq: c_int = 36;
pub const MRB_OPSYM__nmatch: c_int = 37;
pub const MRB_OPSYM__andand: c_int = 40;
pub const MRB_OPSYM__pow: c_int = 41;
pub const MRB_OPSYM__plus: c_int = 42;
pub const MRB_OPSYM__minus: c_int = 43;
pub const MRB_OPSYM__lshift: c_int = 44;
pub const MRB_OPSYM__le: c_int = 45;
pub const MRB_OPSYM__eq: c_int = 46;
pub const MRB_OPSYM__match: c_int = 47;
pub const MRB_OPSYM__ge: c_int = 48;
pub const MRB_OPSYM__rshift: c_int = 49;
pub const MRB_SYM__GC: c_int = 50;
pub const MRB_SYM__IO: c_int = 51;
pub const MRB_SYM__PI: c_int = 52;
pub const MRB_SYM__R3: c_int = 53;
pub const MRB_OPSYM__aref: c_int = 54;
pub const MRB_SYM___1: c_int = 55;
pub const MRB_SYM__af: c_int = 56;
pub const MRB_SYM__ai: c_int = 57;
pub const MRB_SYM__at: c_int = 58;
pub const MRB_SYM__bi: c_int = 59;
pub const MRB_SYM__bs: c_int = 60;
pub const MRB_SYM__cp: c_int = 61;
pub const MRB_SYM__e0: c_int = 62;
pub const MRB_SYM__e2: c_int = 63;
pub const MRB_SYM__e3: c_int = 64;
pub const MRB_SYM__ei: c_int = 65;
pub const MRB_SYM__fd: c_int = 66;
pub const MRB_SYM__gm: c_int = 67;
pub const MRB_SYM__in: c_int = 68;
pub const MRB_SYM__io: c_int = 69;
pub const MRB_SYM__ip: c_int = 70;
pub const MRB_SYM__lz: c_int = 71;
pub const MRB_SYM__nv: c_int = 72;
pub const MRB_SYM__pc: c_int = 73;
pub const MRB_SYM__s2: c_int = 74;
pub const MRB_SYM__sa: c_int = 75;
pub const MRB_SYM__sv: c_int = 76;
pub const MRB_SYM__tp: c_int = 77;
pub const MRB_SYM__tr: c_int = 78;
pub const MRB_SYM__ts: c_int = 79;
pub const MRB_SYM__vs: c_int = 80;
pub const MRB_SYM__wd: c_int = 81;
pub const MRB_OPSYM__oror: c_int = 82;
pub const MRB_OPSYM__cmp: c_int = 83;
pub const MRB_OPSYM__eqq: c_int = 84;
pub const MRB_IVSYM__af: c_int = 85;
pub const MRB_SYM__ANY: c_int = 86;
pub const MRB_SYM__DIG: c_int = 87;
pub const MRB_SYM__Dir: c_int = 88;
pub const MRB_SYM__EIO: c_int = 89;
pub const MRB_SYM__ENV: c_int = 90;
pub const MRB_SYM__GET: c_int = 91;
pub const MRB_SYM__INT: c_int = 92;
pub const MRB_SYM__MAX: c_int = 93;
pub const MRB_SYM__MIN: c_int = 94;
pub const MRB_SYM__NAN: c_int = 95;
pub const MRB_SYM__PUT: c_int = 96;
pub const MRB_SYM__Set: c_int = 97;
pub const MRB_OPSYM__aset: c_int = 98;
pub const MRB_SYM__abs: c_int = 99;
pub const MRB_SYM__add: c_int = 100;
pub const MRB_SYM__app: c_int = 101;
pub const MRB_SYM__arg: c_int = 102;
pub const MRB_SYM__arr: c_int = 103;
pub const MRB_SYM__ary: c_int = 104;
pub const MRB_SYM__blk: c_int = 105;
pub const MRB_SYM__chr: c_int = 106;
pub const MRB_SYM__cmd: c_int = 107;
pub const MRB_SYM__cmp: c_int = 108;
pub const MRB_SYM__cos: c_int = 109;
pub const MRB_SYM__day: c_int = 110;
pub const MRB_SYM__dig: c_int = 111;
pub const MRB_SYM__div: c_int = 112;
pub const MRB_SYM__dup: c_int = 113;
pub const MRB_SYM__end: c_int = 114;
pub const MRB_SYM__env: c_int = 115;
pub const MRB_SYM__eof: c_int = 116;
pub const MRB_SYM__erf: c_int = 117;
pub const MRB_SYM__err: c_int = 118;
pub const MRB_SYM__exp: c_int = 119;
pub const MRB_SYM__ext: c_int = 120;
pub const MRB_SYM__fib: c_int = 121;
pub const MRB_SYM__gcd: c_int = 122;
pub const MRB_SYM__get: c_int = 123;
pub const MRB_SYM__hex: c_int = 124;
pub const MRB_SYM__hsh: c_int = 125;
pub const MRB_SYM__idx: c_int = 126;
pub const MRB_SYM__int: c_int = 127;
pub const MRB_SYM_Q__ip: c_int = 128;
pub const MRB_SYM__key: c_int = 129;
pub const MRB_SYM__kwd: c_int = 130;
pub const MRB_SYM__lcm: c_int = 131;
pub const MRB_SYM__len: c_int = 132;
pub const MRB_SYM__lhs: c_int = 133;
pub const MRB_SYM__lim: c_int = 134;
pub const MRB_SYM__log: c_int = 135;
pub const MRB_SYM__low: c_int = 136;
pub const MRB_SYM__map: c_int = 137;
pub const MRB_SYM__max: c_int = 138;
pub const MRB_SYM__mid: c_int = 139;
pub const MRB_SYM__min: c_int = 140;
pub const MRB_SYM__mon: c_int = 141;
pub const MRB_SYM__msg: c_int = 142;
pub const MRB_SYM__new: c_int = 143;
pub const MRB_SYM__nil: c_int = 144;
pub const MRB_SYM__now: c_int = 145;
pub const MRB_SYM__num: c_int = 146;
pub const MRB_SYM__obj: c_int = 147;
pub const MRB_SYM__oct: c_int = 148;
pub const MRB_SYM__old: c_int = 149;
pub const MRB_SYM__opt: c_int = 150;
pub const MRB_SYM__ord: c_int = 151;
pub const MRB_SYM__out: c_int = 152;
pub const MRB_SYM__pat: c_int = 153;
pub const MRB_SYM__pid: c_int = 154;
pub const MRB_SYM__pop: c_int = 155;
pub const MRB_SYM__pos: c_int = 156;
pub const MRB_SYM__pow: c_int = 157;
pub const MRB_SYM__put: c_int = 158;
pub const MRB_SYM__pwd: c_int = 159;
pub const MRB_SYM__quo: c_int = 160;
pub const MRB_SYM__req: c_int = 161;
pub const MRB_SYM__res: c_int = 162;
pub const MRB_SYM__rhs: c_int = 163;
pub const MRB_SYM__row: c_int = 164;
pub const MRB_SYM__run: c_int = 165;
pub const MRB_SYM__sec: c_int = 166;
pub const MRB_SYM__set: c_int = 167;
pub const MRB_SYM__sin: c_int = 168;
pub const MRB_SYM__str: c_int = 169;
pub const MRB_SYM__sub: c_int = 170;
pub const MRB_SYM__sum: c_int = 171;
pub const MRB_SYM__sym: c_int = 172;
pub const MRB_SYM__tag: c_int = 173;
pub const MRB_SYM__tan: c_int = 174;
pub const MRB_SYM__tap: c_int = 175;
pub const MRB_SYM__tcp: c_int = 176;
pub const MRB_SYM__tmp: c_int = 177;
pub const MRB_SYM_B__tr: c_int = 178;
pub const MRB_SYM__udp: c_int = 179;
pub const MRB_SYM__url: c_int = 180;
pub const MRB_SYM__use: c_int = 181;
pub const MRB_SYM__utc: c_int = 182;
pub const MRB_SYM__val: c_int = 183;
pub const MRB_SYM__zip: c_int = 184;
pub const MRB_IVSYM__app: c_int = 185;
pub const MRB_IVSYM__dst: c_int = 186;
pub const MRB_IVSYM__fib: c_int = 187;
pub const MRB_IVSYM__kwd: c_int = 188;
pub const MRB_IVSYM__map: c_int = 189;
pub const MRB_IVSYM__obj: c_int = 190;
pub const MRB_IVSYM__pos: c_int = 191;
pub const MRB_IVSYM__run: c_int = 192;
pub const MRB_IVSYM__tag: c_int = 193;
pub const MRB_IVSYM__use: c_int = 194;
pub const MRB_SYM__ARGV: c_int = 195;
pub const MRB_SYM__Data: c_int = 196;
pub const MRB_SYM__EADV: c_int = 197;
pub const MRB_SYM__EDOM: c_int = 198;
pub const MRB_SYM__EXCL: c_int = 199;
pub const MRB_SYM__FREE: c_int = 200;
pub const MRB_SYM__File: c_int = 201;
pub const MRB_SYM__HEAD: c_int = 202;
pub const MRB_SYM__Hash: c_int = 203;
pub const MRB_SYM__Head: c_int = 204;
pub const MRB_SYM__INFO: c_int = 205;
pub const MRB_SYM__LINK: c_int = 206;
pub const MRB_SYM__Lazy: c_int = 207;
pub const MRB_SYM__Math: c_int = 208;
pub const MRB_SYM__Mime: c_int = 209;
pub const MRB_SYM__NONE: c_int = 210;
pub const MRB_SYM__NULL: c_int = 211;
pub const MRB_SYM__POST: c_int = 212;
pub const MRB_SYM__Proc: c_int = 213;
pub const MRB_SYM__RDWR: c_int = 214;
pub const MRB_SYM__SYNC: c_int = 215;
pub const MRB_SYM__Time: c_int = 216;
pub const MRB_SYM__Tree: c_int = 217;
pub const MRB_SYM__abs2: c_int = 218;
pub const MRB_SYM__acos: c_int = 219;
pub const MRB_SYM_Q__add: c_int = 220;
pub const MRB_SYM__addr: c_int = 221;
pub const MRB_SYM_Q__all: c_int = 222;
pub const MRB_SYM_Q__any: c_int = 223;
pub const MRB_SYM__arg0: c_int = 224;
pub const MRB_SYM__arg1: c_int = 225;
pub const MRB_SYM__arg2: c_int = 226;
pub const MRB_SYM__args: c_int = 227;
pub const MRB_SYM__argv: c_int = 228;
pub const MRB_SYM__arys: c_int = 229;
pub const MRB_SYM__asin: c_int = 230;
pub const MRB_SYM__atan: c_int = 231;
pub const MRB_SYM__attr: c_int = 232;
pub const MRB_SYM__bind: c_int = 233;
pub const MRB_SYM__body: c_int = 234;
pub const MRB_SYM__bool: c_int = 235;
pub const MRB_SYM__bsiz: c_int = 236;
pub const MRB_SYM__byte: c_int = 237;
pub const MRB_SYM__call: c_int = 238;
pub const MRB_SYM__cbrt: c_int = 239;
pub const MRB_SYM__ceil: c_int = 240;
pub const MRB_SYM__char: c_int = 241;
pub const MRB_SYM__chop: c_int = 242;
pub const MRB_SYM__code: c_int = 243;
pub const MRB_SYM__conj: c_int = 244;
pub const MRB_SYM__cosh: c_int = 245;
pub const MRB_SYM__curr: c_int = 246;
pub const MRB_SYM__data: c_int = 247;
pub const MRB_SYM__drop: c_int = 248;
pub const MRB_SYM_Q__dst: c_int = 249;
pub const MRB_SYM__dump: c_int = 250;
pub const MRB_SYM__each: c_int = 251;
pub const MRB_SYM__elem: c_int = 252;
pub const MRB_SYM__enum: c_int = 253;
pub const MRB_SYM_Q__eof: c_int = 254;
pub const MRB_SYM_Q__eql: c_int = 255;
pub const MRB_SYM__erfc: c_int = 256;
pub const MRB_SYM__eval: c_int = 257;
pub const MRB_SYM__exit: c_int = 258;
pub const MRB_SYM__fail: c_int = 259;
pub const MRB_SYM__fdiv: c_int = 260;
pub const MRB_SYM__feed: c_int = 261;
pub const MRB_SYM__file: c_int = 262;
pub const MRB_SYM__fill: c_int = 263;
pub const MRB_SYM__find: c_int = 264;
pub const MRB_SYM__flag: c_int = 265;
pub const MRB_SYM__free: c_int = 266;
pub const MRB_SYM__func: c_int = 267;
pub const MRB_SYM__getc: c_int = 268;
pub const MRB_SYM__gets: c_int = 269;
pub const MRB_SYM_Q__gmt: c_int = 270;
pub const MRB_SYM__grep: c_int = 271;
pub const MRB_SYM__gsub: c_int = 272;
pub const MRB_SYM__hash: c_int = 273;
pub const MRB_SYM__high: c_int = 274;
pub const MRB_SYM__host: c_int = 275;
pub const MRB_SYM__hour: c_int = 276;
pub const MRB_SYM__imag: c_int = 277;
pub const MRB_SYM__init: c_int = 278;
pub const MRB_SYM__item: c_int = 279;
pub const MRB_SYM__join: c_int = 280;
pub const MRB_SYM_Q__key: c_int = 281;
pub const MRB_SYM__keys: c_int = 282;
pub const MRB_SYM__last: c_int = 283;
pub const MRB_SYM__lazy: c_int = 284;
pub const MRB_SYM__line: c_int = 285;
pub const MRB_SYM__log2: c_int = 286;
pub const MRB_SYM__loop: c_int = 287;
pub const MRB_SYM_B__map: c_int = 288;
pub const MRB_SYM__mask: c_int = 289;
pub const MRB_SYM__mday: c_int = 290;
pub const MRB_SYM__mesg: c_int = 291;
pub const MRB_SYM__meth: c_int = 292;
pub const MRB_SYM__mode: c_int = 293;
pub const MRB_SYM__name: c_int = 294;
pub const MRB_SYM_Q__nan: c_int = 295;
pub const MRB_SYM__next: c_int = 296;
pub const MRB_SYM_Q__nil: c_int = 297;
pub const MRB_SYM__none: c_int = 298;
pub const MRB_SYM__nsec: c_int = 299;
pub const MRB_SYM__ntop: c_int = 300;
pub const MRB_SYM_Q__odd: c_int = 301;
pub const MRB_SYM_Q__one: c_int = 302;
pub const MRB_SYM__open: c_int = 303;
pub const MRB_SYM__opts: c_int = 304;
pub const MRB_SYM__pack: c_int = 305;
pub const MRB_SYM__pair: c_int = 306;
pub const MRB_SYM__part: c_int = 307;
pub const MRB_SYM__path: c_int = 308;
pub const MRB_SYM__peek: c_int = 309;
pub const MRB_SYM__perm: c_int = 310;
pub const MRB_SYM__pipe: c_int = 311;
pub const MRB_SYM__plen: c_int = 312;
pub const MRB_SYM__port: c_int = 313;
pub const MRB_SYM_E__pos: c_int = 314;
pub const MRB_SYM__post: c_int = 315;
pub const MRB_SYM__proc: c_int = 316;
pub const MRB_SYM__pton: c_int = 317;
pub const MRB_SYM__push: c_int = 318;
pub const MRB_SYM__putc: c_int = 319;
pub const MRB_SYM__puts: c_int = 320;
pub const MRB_SYM__rand: c_int = 321;
pub const MRB_SYM__read: c_int = 322;
pub const MRB_SYM__real: c_int = 323;
pub const MRB_SYM__rect: c_int = 324;
pub const MRB_SYM__recv: c_int = 325;
pub const MRB_SYM__rest: c_int = 326;
pub const MRB_SYM__root: c_int = 327;
pub const MRB_SYM__sary: c_int = 328;
pub const MRB_SYM__seek: c_int = 329;
pub const MRB_SYM__send: c_int = 330;
pub const MRB_SYM__sinh: c_int = 331;
pub const MRB_SYM__size: c_int = 332;
pub const MRB_SYM__sock: c_int = 333;
pub const MRB_SYM__sort: c_int = 334;
pub const MRB_SYM__sqrt: c_int = 335;
pub const MRB_SYM__step: c_int = 336;
pub const MRB_SYM_B__sub: c_int = 337;
pub const MRB_SYM__succ: c_int = 338;
pub const MRB_SYM__sync: c_int = 339;
pub const MRB_SYM__take: c_int = 340;
pub const MRB_SYM__tanh: c_int = 341;
pub const MRB_SYM__tell: c_int = 342;
pub const MRB_SYM__then: c_int = 343;
pub const MRB_SYM__to_a: c_int = 344;
pub const MRB_SYM__to_c: c_int = 345;
pub const MRB_SYM__to_f: c_int = 346;
pub const MRB_SYM__to_h: c_int = 347;
pub const MRB_SYM__to_i: c_int = 348;
pub const MRB_SYM__to_r: c_int = 349;
pub const MRB_SYM__to_s: c_int = 350;
pub const MRB_SYM__tr_s: c_int = 351;
pub const MRB_SYM__trap: c_int = 352;
pub const MRB_SYM_Q__tty: c_int = 353;
pub const MRB_SYM__type: c_int = 354;
pub const MRB_SYM__uniq: c_int = 355;
pub const MRB_SYM__unix: c_int = 356;
pub const MRB_SYM__upto: c_int = 357;
pub const MRB_SYM__urls: c_int = 358;
pub const MRB_SYM__usec: c_int = 359;
pub const MRB_SYM_Q__utc: c_int = 360;
pub const MRB_SYM__vals: c_int = 361;
pub const MRB_SYM__wday: c_int = 362;
pub const MRB_SYM__yday: c_int = 363;
pub const MRB_SYM__year: c_int = 364;
pub const MRB_SYM__zone: c_int = 365;
pub const MRB_IVSYM__args: c_int = 366;
pub const MRB_IVSYM__data: c_int = 367;
pub const MRB_IVSYM__meth: c_int = 368;
pub const MRB_IVSYM__name: c_int = 369;
pub const MRB_IVSYM__path: c_int = 370;
pub const MRB_IVSYM__proc: c_int = 371;
pub const MRB_IVSYM__root: c_int = 372;
pub const MRB_IVSYM__size: c_int = 373;
pub const MRB_IVSYM__tree: c_int = 374;
pub const MRB_IVSYM__urls: c_int = 375;
pub const MRB_SYM__Array: c_int = 376;
pub const MRB_SYM__CREAT: c_int = 377;
pub const MRB_SYM__Chain: c_int = 378;
pub const MRB_SYM__Class: c_int = 379;
pub const MRB_SYM__DSYNC: c_int = 380;
pub const MRB_SYM__E2BIG: c_int = 381;
pub const MRB_SYM__EAUTH: c_int = 382;
pub const MRB_SYM__EBADE: c_int = 383;
pub const MRB_SYM__EBADF: c_int = 384;
pub const MRB_SYM__EBADR: c_int = 385;
pub const MRB_SYM__EBUSY: c_int = 386;
pub const MRB_SYM__ECOMM: c_int = 387;
pub const MRB_SYM__EFBIG: c_int = 388;
pub const MRB_SYM__EIDRM: c_int = 389;
pub const MRB_SYM__EINTR: c_int = 390;
pub const MRB_SYM__ELOOP: c_int = 391;
pub const MRB_SYM__ENOSR: c_int = 392;
pub const MRB_SYM__ENXIO: c_int = 393;
pub const MRB_SYM__EPERM: c_int = 394;
pub const MRB_SYM__EPIPE: c_int = 395;
pub const MRB_SYM__EROFS: c_int = 396;
pub const MRB_SYM__ESRCH: c_int = 397;
pub const MRB_SYM__ETIME: c_int = 398;
pub const MRB_SYM__EXDEV: c_int = 399;
pub const MRB_SYM__Errno: c_int = 400;
pub const MRB_SYM__Fiber: c_int = 401;
pub const MRB_SYM__Float: c_int = 402;
pub const MRB_SYM__HTTPS: c_int = 403;
pub const MRB_SYM__PATCH: c_int = 404;
pub const MRB_SYM__RADIX: c_int = 405;
pub const MRB_SYM__RSYNC: c_int = 406;
pub const MRB_SYM__Range: c_int = 407;
pub const MRB_SYM__STDIN: c_int = 408;
pub const MRB_SYM__Shelf: c_int = 409;
pub const MRB_SYM__TOTAL: c_int = 410;
pub const MRB_SYM__TRACE: c_int = 411;
pub const MRB_SYM__TRUNC: c_int = 412;
pub const MRB_SYM__T_ENV: c_int = 413;
pub const MRB_SYM__Utils: c_int = 414;
pub const MRB_SYM____xor: c_int = 415;
pub const MRB_SYM___bind: c_int = 416;
pub const MRB_SYM___keys: c_int = 417;
pub const MRB_SYM___name: c_int = 418;
pub const MRB_SYM___pipe: c_int = 419;
pub const MRB_SYM___proc: c_int = 420;
pub const MRB_SYM___recv: c_int = 421;
pub const MRB_SYM__acosh: c_int = 422;
pub const MRB_SYM__angle: c_int = 423;
pub const MRB_SYM__arity: c_int = 424;
pub const MRB_SYM__ary_F: c_int = 425;
pub const MRB_SYM__ary_T: c_int = 426;
pub const MRB_SYM__asinh: c_int = 427;
pub const MRB_SYM__assoc: c_int = 428;
pub const MRB_SYM__atan2: c_int = 429;
pub const MRB_SYM__atanh: c_int = 430;
pub const MRB_SYM__atime: c_int = 431;
pub const MRB_SYM__begin: c_int = 432;
pub const MRB_SYM__block: c_int = 433;
pub const MRB_SYM__bytes: c_int = 434;
pub const MRB_SYM__catch: c_int = 435;
pub const MRB_SYM__chain: c_int = 436;
pub const MRB_SYM__chars: c_int = 437;
pub const MRB_SYM__chdir: c_int = 438;
pub const MRB_SYM__chmod: c_int = 439;
pub const MRB_SYM__chomp: c_int = 440;
pub const MRB_SYM_B__chop: c_int = 441;
pub const MRB_SYM__chunk: c_int = 442;
pub const MRB_SYM__clamp: c_int = 443;
pub const MRB_SYM__class: c_int = 444;
pub const MRB_SYM__clean: c_int = 445;
pub const MRB_SYM__clear: c_int = 446;
pub const MRB_SYM__clone: c_int = 447;
pub const MRB_SYM__close: c_int = 448;
pub const MRB_SYM__const: c_int = 449;
pub const MRB_SYM__count: c_int = 450;
pub const MRB_SYM__ctime: c_int = 451;
pub const MRB_SYM__curry: c_int = 452;
pub const MRB_SYM__cycle: c_int = 453;
pub const MRB_SYM__debug: c_int = 454;
pub const MRB_SYM__enums: c_int = 455;
pub const MRB_SYM__errno: c_int = 456;
pub const MRB_SYM_Q__even: c_int = 457;
pub const MRB_SYM__expm1: c_int = 458;
pub const MRB_SYM__fetch: c_int = 459;
pub const MRB_SYM__field: c_int = 460;
pub const MRB_SYM_Q__file: c_int = 461;
pub const MRB_SYM__first: c_int = 462;
pub const MRB_SYM__flags: c_int = 463;
pub const MRB_SYM__flock: c_int = 464;
pub const MRB_SYM__floor: c_int = 465;
pub const MRB_SYM__flush: c_int = 466;
pub const MRB_SYM__force: c_int = 467;
pub const MRB_SYM__found: c_int = 468;
pub const MRB_SYM__frexp: c_int = 469;
pub const MRB_SYM__getgm: c_int = 470;
pub const MRB_SYM__getwd: c_int = 471;
pub const MRB_SYM__group: c_int = 472;
pub const MRB_SYM_B__gsub: c_int = 473;
pub const MRB_SYM__hypot: c_int = 474;
pub const MRB_SYM__index: c_int = 475;
pub const MRB_SYM_Q__ipv4: c_int = 476;
pub const MRB_SYM_Q__ipv6: c_int = 477;
pub const MRB_SYM_Q__is_a: c_int = 478;
pub const MRB_SYM__klass: c_int = 479;
pub const MRB_SYM__ldexp: c_int = 480;
pub const MRB_SYM__level: c_int = 481;
pub const MRB_SYM__lines: c_int = 482;
pub const MRB_SYM__ljust: c_int = 483;
pub const MRB_SYM__local: c_int = 484;
pub const MRB_SYM__log10: c_int = 485;
pub const MRB_SYM__log1p: c_int = 486;
pub const MRB_SYM__match: c_int = 487;
pub const MRB_SYM__merge: c_int = 488;
pub const MRB_SYM__mkdir: c_int = 489;
pub const MRB_SYM__month: c_int = 490;
pub const MRB_SYM__mtime: c_int = 491;
pub const MRB_SYM_B__next: c_int = 492;
pub const MRB_SYM_Q__none: c_int = 493;
pub const MRB_SYM__other: c_int = 494;
pub const MRB_SYM__owner: c_int = 495;
pub const MRB_SYM__parts: c_int = 496;
pub const MRB_SYM__phase: c_int = 497;
pub const MRB_SYM_Q__pipe: c_int = 498;
pub const MRB_SYM__polar: c_int = 499;
pub const MRB_SYM__popen: c_int = 500;
pub const MRB_SYM__pproc: c_int = 501;
pub const MRB_SYM__pread: c_int = 502;
pub const MRB_SYM__print: c_int = 503;
pub const MRB_SYM__proto: c_int = 504;
pub const MRB_SYM__quiet: c_int = 505;
pub const MRB_SYM__raise: c_int = 506;
pub const MRB_SYM_Q__real: c_int = 507;
pub const MRB_SYM__remap: c_int = 508;
pub const MRB_SYM__reset: c_int = 509;
pub const MRB_SYM__rfind: c_int = 510;
pub const MRB_SYM__rjust: c_int = 511;
pub const MRB_SYM__rmdir: c_int = 512;
pub const MRB_SYM__round: c_int = 513;
pub const MRB_SYM__route: c_int = 514;
pub const MRB_SYM__shift: c_int = 515;
pub const MRB_SYM_Q__size: c_int = 516;
pub const MRB_SYM__slice: c_int = 517;
pub const MRB_SYM_B__sort: c_int = 518;
pub const MRB_SYM__split: c_int = 519;
pub const MRB_SYM__srand: c_int = 520;
pub const MRB_SYM__start: c_int = 521;
pub const MRB_SYM__state: c_int = 522;
pub const MRB_SYM__store: c_int = 523;
pub const MRB_SYM__strip: c_int = 524;
pub const MRB_SYM_B__succ: c_int = 525;
pub const MRB_SYM_E__sync: c_int = 526;
pub const MRB_SYM__taken: c_int = 527;
pub const MRB_SYM__tally: c_int = 528;
pub const MRB_SYM__throw: c_int = 529;
pub const MRB_SYM__times: c_int = 530;
pub const MRB_SYM__total: c_int = 531;
pub const MRB_SYM_B__tr_s: c_int = 532;
pub const MRB_SYM__umask: c_int = 533;
pub const MRB_SYM__union: c_int = 534;
pub const MRB_SYM_B__uniq: c_int = 535;
pub const MRB_SYM_Q__unix: c_int = 536;
pub const MRB_SYM__value: c_int = 537;
pub const MRB_SYM__write: c_int = 538;
pub const MRB_SYM__yield: c_int = 539;
pub const MRB_SYM_Q__zero: c_int = 540;
pub const MRB_GVSYM__DEBUG: c_int = 541;
pub const MRB_GVSYM__stdin: c_int = 542;
pub const MRB_IVSYM__enums: c_int = 543;
pub const MRB_IVSYM__index: c_int = 544;
pub const MRB_IVSYM__level: c_int = 545;
pub const MRB_IVSYM__value: c_int = 546;
pub const MRB_SYM__AF_MAX: c_int = 547;
pub const MRB_SYM__APPEND: c_int = 548;
pub const MRB_SYM__BINARY: c_int = 549;
pub const MRB_SYM__DELETE: c_int = 550;
pub const MRB_SYM__DIRECT: c_int = 551;
pub const MRB_SYM__EACCES: c_int = 552;
pub const MRB_SYM__EAGAIN: c_int = 553;
pub const MRB_SYM__EBADFD: c_int = 554;
pub const MRB_SYM__EBFONT: c_int = 555;
pub const MRB_SYM__ECHILD: c_int = 556;
pub const MRB_SYM__ECHRNG: c_int = 557;
pub const MRB_SYM__EDQUOT: c_int = 558;
pub const MRB_SYM__EEXIST: c_int = 559;
pub const MRB_SYM__EFAULT: c_int = 560;
pub const MRB_SYM__EFTYPE: c_int = 561;
pub const MRB_SYM__EILSEQ: c_int = 562;
pub const MRB_SYM__EINVAL: c_int = 563;
pub const MRB_SYM__EIPSEC: c_int = 564;
pub const MRB_SYM__EISDIR: c_int = 565;
pub const MRB_SYM__EISNAM: c_int = 566;
pub const MRB_SYM__EL2HLT: c_int = 567;
pub const MRB_SYM__EL3HLT: c_int = 568;
pub const MRB_SYM__EL3RST: c_int = 569;
pub const MRB_SYM__ELNRNG: c_int = 570;
pub const MRB_SYM__EMFILE: c_int = 571;
pub const MRB_SYM__EMLINK: c_int = 572;
pub const MRB_SYM__ENFILE: c_int = 573;
pub const MRB_SYM__ENOANO: c_int = 574;
pub const MRB_SYM__ENOCSI: c_int = 575;
pub const MRB_SYM__ENODEV: c_int = 576;
pub const MRB_SYM__ENOENT: c_int = 577;
pub const MRB_SYM__ENOKEY: c_int = 578;
pub const MRB_SYM__ENOLCK: c_int = 579;
pub const MRB_SYM__ENOMEM: c_int = 580;
pub const MRB_SYM__ENOMSG: c_int = 581;
pub const MRB_SYM__ENONET: c_int = 582;
pub const MRB_SYM__ENOPKG: c_int = 583;
pub const MRB_SYM__ENOSPC: c_int = 584;
pub const MRB_SYM__ENOSTR: c_int = 585;
pub const MRB_SYM__ENOSYS: c_int = 586;
pub const MRB_SYM__ENOTTY: c_int = 587;
pub const MRB_SYM__EPROTO: c_int = 588;
pub const MRB_SYM__EQFULL: c_int = 589;
pub const MRB_SYM__ERANGE: c_int = 590;
pub const MRB_SYM__ESPIPE: c_int = 591;
pub const MRB_SYM__ESRMNT: c_int = 592;
pub const MRB_SYM__ESTALE: c_int = 593;
pub const MRB_SYM__EUSERS: c_int = 594;
pub const MRB_SYM__EXFULL: c_int = 595;
pub const MRB_SYM__Fixnum: c_int = 596;
pub const MRB_SYM__Heeler: c_int = 597;
pub const MRB_SYM__IP_MTU: c_int = 598;
pub const MRB_SYM__IP_TOS: c_int = 599;
pub const MRB_SYM__IP_TTL: c_int = 600;
pub const MRB_SYM__Kernel: c_int = 601;
pub const MRB_SYM__Logger: c_int = 602;
pub const MRB_SYM__Method: c_int = 603;
pub const MRB_SYM__Module: c_int = 604;
pub const MRB_SYM__NOCTTY: c_int = 605;
pub const MRB_SYM__Object: c_int = 606;
pub const MRB_SYM__Option: c_int = 607;
pub const MRB_SYM__RDONLY: c_int = 608;
pub const MRB_SYM__Random: c_int = 609;
pub const MRB_SYM__Regexp: c_int = 610;
pub const MRB_SYM__SOL_IP: c_int = 611;
pub const MRB_SYM__STDERR: c_int = 612;
pub const MRB_SYM__STDOUT: c_int = 613;
pub const MRB_SYM__Server: c_int = 614;
pub const MRB_SYM__Socket: c_int = 615;
pub const MRB_SYM__Static: c_int = 616;
pub const MRB_SYM__Status: c_int = 617;
pub const MRB_SYM__String: c_int = 618;
pub const MRB_SYM__Struct: c_int = 619;
pub const MRB_SYM__Symbol: c_int = 620;
pub const MRB_SYM__T_CPTR: c_int = 621;
pub const MRB_SYM__T_DATA: c_int = 622;
pub const MRB_SYM__T_HASH: c_int = 623;
pub const MRB_SYM__T_PROC: c_int = 624;
pub const MRB_SYM__UNLINK: c_int = 625;
pub const MRB_SYM__WRONLY: c_int = 626;
pub const MRB_SYM____id__: c_int = 627;
pub const MRB_SYM____init: c_int = 628;
pub const MRB_SYM____uniq: c_int = 629;
pub const MRB_SYM___alone: c_int = 630;
pub const MRB_SYM___atime: c_int = 631;
pub const MRB_SYM___chdir: c_int = 632;
pub const MRB_SYM___ctime: c_int = 633;
pub const MRB_SYM___klass: c_int = 634;
pub const MRB_SYM___mtime: c_int = 635;
pub const MRB_SYM___owner: c_int = 636;
pub const MRB_SYM___popen: c_int = 637;
pub const MRB_SYM__accept: c_int = 638;
pub const MRB_SYM_Q__alive: c_int = 639;
pub const MRB_SYM__append: c_int = 640;
pub const MRB_SYM__caller: c_int = 641;
pub const MRB_SYM__center: c_int = 642;
pub const MRB_SYM_B__chomp: c_int = 643;
pub const MRB_SYM__chroot: c_int = 644;
pub const MRB_SYM__concat: c_int = 645;
pub const MRB_SYM_Q__cover: c_int = 646;
pub const MRB_SYM__define: c_int = 647;
pub const MRB_SYM__delete: c_int = 648;
pub const MRB_SYM__detect: c_int = 649;
pub const MRB_SYM__digits: c_int = 650;
pub const MRB_SYM__divide: c_int = 651;
pub const MRB_SYM__divmod: c_int = 652;
pub const MRB_SYM__domain: c_int = 653;
pub const MRB_SYM__downto: c_int = 654;
pub const MRB_SYM_Q__empty: c_int = 655;
pub const MRB_SYM__enable: c_int = 656;
pub const MRB_SYM_Q__equal: c_int = 657;
pub const MRB_SYM__except: c_int = 658;
pub const MRB_SYM_Q__exist: c_int = 659;
pub const MRB_SYM__extend: c_int = 660;
pub const MRB_SYM__family: c_int = 661;
pub const MRB_SYM__fileno: c_int = 662;
pub const MRB_SYM__filter: c_int = 663;
pub const MRB_SYM__for_fd: c_int = 664;
pub const MRB_SYM__format: c_int = 665;
pub const MRB_SYM__freeze: c_int = 666;
pub const MRB_SYM__getutc: c_int = 667;
pub const MRB_SYM__gmtime: c_int = 668;
pub const MRB_SYM__gmtoff: c_int = 669;
pub const MRB_SYM__grep_v: c_int = 670;
pub const MRB_SYM__header: c_int = 671;
pub const MRB_SYM__ifnone: c_int = 672;
pub const MRB_SYM__inject: c_int = 673;
pub const MRB_SYM__insert: c_int = 674;
pub const MRB_SYM__intern: c_int = 675;
pub const MRB_SYM__invert: c_int = 676;
pub const MRB_SYM__isatty: c_int = 677;
pub const MRB_SYM__itself: c_int = 678;
pub const MRB_SYM__lambda: c_int = 679;
pub const MRB_SYM__length: c_int = 680;
pub const MRB_SYM__linger: c_int = 681;
pub const MRB_SYM__listen: c_int = 682;
pub const MRB_SYM__logger: c_int = 683;
pub const MRB_SYM__lstrip: c_int = 684;
pub const MRB_SYM__mapped: c_int = 685;
pub const MRB_SYM_Q__match: c_int = 686;
pub const MRB_SYM__max_by: c_int = 687;
pub const MRB_SYM__maxlen: c_int = 688;
pub const MRB_SYM_B__merge: c_int = 689;
pub const MRB_SYM__method: c_int = 690;
pub const MRB_SYM__min_by: c_int = 691;
pub const MRB_SYM__minmax: c_int = 692;
pub const MRB_SYM__mktime: c_int = 693;
pub const MRB_SYM__modulo: c_int = 694;
pub const MRB_SYM__object: c_int = 695;
pub const MRB_SYM__offset: c_int = 696;
pub const MRB_SYM__others: c_int = 697;
pub const MRB_SYM__params: c_int = 698;
pub const MRB_SYM__printf: c_int = 699;
pub const MRB_SYM__public: c_int = 700;
pub const MRB_SYM__pwrite: c_int = 701;
pub const MRB_SYM__random: c_int = 702;
pub const MRB_SYM__rassoc: c_int = 703;
pub const MRB_SYM__reduce: c_int = 704;
pub const MRB_SYM__rehash: c_int = 705;
pub const MRB_SYM__reject: c_int = 706;
pub const MRB_SYM__rename: c_int = 707;
pub const MRB_SYM__result: c_int = 708;
pub const MRB_SYM__resume: c_int = 709;
pub const MRB_SYM__rewind: c_int = 710;
pub const MRB_SYM__rindex: c_int = 711;
pub const MRB_SYM__rotate: c_int = 712;
pub const MRB_SYM__routes: c_int = 713;
pub const MRB_SYM__rstrip: c_int = 714;
pub const MRB_SYM__sample: c_int = 715;
pub const MRB_SYM__select: c_int = 716;
pub const MRB_SYM__server: c_int = 717;
pub const MRB_SYM_B__slice: c_int = 718;
pub const MRB_SYM__status: c_int = 719;
pub const MRB_SYM__string: c_int = 720;
pub const MRB_SYM_B__strip: c_int = 721;
pub const MRB_SYM__to_app: c_int = 722;
pub const MRB_SYM__to_int: c_int = 723;
pub const MRB_SYM__to_str: c_int = 724;
pub const MRB_SYM__to_sym: c_int = 725;
pub const MRB_SYM__unbind: c_int = 726;
pub const MRB_SYM__ungetc: c_int = 727;
pub const MRB_SYM__unlink: c_int = 728;
pub const MRB_SYM__unpack: c_int = 729;
pub const MRB_SYM__upcase: c_int = 730;
pub const MRB_SYM__update: c_int = 731;
pub const MRB_SYM_Q__value: c_int = 732;
pub const MRB_SYM__values: c_int = 733;
pub const MRB_GVSYM__stderr: c_int = 734;
pub const MRB_GVSYM__stdout: c_int = 735;
pub const MRB_IVSYM__family: c_int = 736;
pub const MRB_IVSYM__logger: c_int = 737;
pub const MRB_IVSYM__routes: c_int = 738;
pub const MRB_IVSYM__server: c_int = 739;
pub const MRB_SYM__AF_INET: c_int = 740;
pub const MRB_SYM__AF_UNIX: c_int = 741;
pub const MRB_SYM__Binding: c_int = 742;
pub const MRB_SYM__Builder: c_int = 743;
pub const MRB_SYM__CFORMAT: c_int = 744;
pub const MRB_SYM__Complex: c_int = 745;
pub const MRB_SYM__DFORMAT: c_int = 746;
pub const MRB_SYM__EBADMSG: c_int = 747;
pub const MRB_SYM__EBADRPC: c_int = 748;
pub const MRB_SYM__EBADRQC: c_int = 749;
pub const MRB_SYM__EBADSLT: c_int = 750;
pub const MRB_SYM__EDEADLK: c_int = 751;
pub const MRB_SYM__EDEVERR: c_int = 752;
pub const MRB_SYM__EDOOFUS: c_int = 753;
pub const MRB_SYM__EDOTDOT: c_int = 754;
pub const MRB_SYM__EISCONN: c_int = 755;
pub const MRB_SYM__ELIBACC: c_int = 756;
pub const MRB_SYM__ELIBBAD: c_int = 757;
pub const MRB_SYM__ELIBMAX: c_int = 758;
pub const MRB_SYM__ELIBSCN: c_int = 759;
pub const MRB_SYM__ENAVAIL: c_int = 760;
pub const MRB_SYM__ENOATTR: c_int = 761;
pub const MRB_SYM__ENOBUFS: c_int = 762;
pub const MRB_SYM__ENODATA: c_int = 763;
pub const MRB_SYM__ENOEXEC: c_int = 764;
pub const MRB_SYM__ENOLINK: c_int = 765;
pub const MRB_SYM__ENOTBLK: c_int = 766;
pub const MRB_SYM__ENOTDIR: c_int = 767;
pub const MRB_SYM__ENOTNAM: c_int = 768;
pub const MRB_SYM__ENOTSUP: c_int = 769;
pub const MRB_SYM__EPSILON: c_int = 770;
pub const MRB_SYM__EPWROFF: c_int = 771;
pub const MRB_SYM__EREMCHG: c_int = 772;
pub const MRB_SYM__EREMOTE: c_int = 773;
pub const MRB_SYM__ERFKILL: c_int = 774;
pub const MRB_SYM__ETXTBSY: c_int = 775;
pub const MRB_SYM__EUCLEAN: c_int = 776;
pub const MRB_SYM__EUNATCH: c_int = 777;
pub const MRB_SYM__Handler: c_int = 778;
pub const MRB_SYM__IOError: c_int = 779;
pub const MRB_SYM__Integer: c_int = 780;
pub const MRB_SYM__LOCK_EX: c_int = 781;
pub const MRB_SYM__LOCK_NB: c_int = 782;
pub const MRB_SYM__LOCK_SH: c_int = 783;
pub const MRB_SYM__LOCK_UN: c_int = 784;
pub const MRB_SYM__MAX_EXP: c_int = 785;
pub const MRB_SYM__MIN_EXP: c_int = 786;
pub const MRB_SYM__MSG_EOR: c_int = 787;
pub const MRB_SYM__MSG_OOB: c_int = 788;
pub const MRB_SYM__NOATIME: c_int = 789;
pub const MRB_SYM__NOERROR: c_int = 790;
pub const MRB_SYM__Numeric: c_int = 791;
pub const MRB_SYM__OPTIONS: c_int = 792;
pub const MRB_SYM__PF_INET: c_int = 793;
pub const MRB_SYM__PF_UNIX: c_int = 794;
pub const MRB_SYM__Process: c_int = 795;
pub const MRB_SYM__SHUT_RD: c_int = 796;
pub const MRB_SYM__SHUT_WR: c_int = 797;
pub const MRB_SYM__SOL_TCP: c_int = 798;
pub const MRB_SYM__SO_TYPE: c_int = 799;
pub const MRB_SYM__TMPFILE: c_int = 800;
pub const MRB_SYM__T_ARRAY: c_int = 801;
pub const MRB_SYM__T_BREAK: c_int = 802;
pub const MRB_SYM__T_CLASS: c_int = 803;
pub const MRB_SYM__T_FIBER: c_int = 804;
pub const MRB_SYM__T_FLOAT: c_int = 805;
pub const MRB_SYM__T_RANGE: c_int = 806;
pub const MRB_SYM__Yielder: c_int = 807;
pub const MRB_SYM____chars: c_int = 808;
pub const MRB_SYM____fetch: c_int = 809;
pub const MRB_SYM____lines: c_int = 810;
pub const MRB_SYM____merge: c_int = 811;
pub const MRB_SYM____union: c_int = 812;
pub const MRB_SYM_B____uniq: c_int = 813;
pub const MRB_SYM___accept: c_int = 814;
pub const MRB_SYM___listen: c_int = 815;
pub const MRB_SYM___socket: c_int = 816;
pub const MRB_SYM__add_all: c_int = 817;
pub const MRB_SYM__afamily: c_int = 818;
pub const MRB_SYM__asctime: c_int = 819;
pub const MRB_SYM__backlog: c_int = 820;
pub const MRB_SYM__binding: c_int = 821;
pub const MRB_SYM__bsearch: c_int = 822;
pub const MRB_SYM__casecmp: c_int = 823;
pub const MRB_SYM__ceildiv: c_int = 824;
pub const MRB_SYM_Q__closed: c_int = 825;
pub const MRB_SYM__collect: c_int = 826;
pub const MRB_SYM__command: c_int = 827;
pub const MRB_SYM__compact: c_int = 828;
pub const MRB_SYM__compile: c_int = 829;
pub const MRB_SYM__connect: c_int = 830;
pub const MRB_SYM__current: c_int = 831;
pub const MRB_SYM__default: c_int = 832;
pub const MRB_SYM_B__delete: c_int = 833;
pub const MRB_SYM_Q__delete: c_int = 834;
pub const MRB_SYM__dirname: c_int = 835;
pub const MRB_SYM__disable: c_int = 836;
pub const MRB_SYM__dropped: c_int = 837;
pub const MRB_SYM__element: c_int = 838;
pub const MRB_SYM__entries: c_int = 839;
pub const MRB_SYM_Q__exists: c_int = 840;
pub const MRB_SYM__extname: c_int = 841;
pub const MRB_SYM_B__filter: c_int = 842;
pub const MRB_SYM_Q__finite: c_int = 843;
pub const MRB_SYM__flatten: c_int = 844;
pub const MRB_SYM__foreach: c_int = 845;
pub const MRB_SYM_Q__friday: c_int = 846;
pub const MRB_SYM_Q__frozen: c_int = 847;
pub const MRB_SYM__getbyte: c_int = 848;
pub const MRB_SYM__headers: c_int = 849;
pub const MRB_SYM__include: c_int = 850;
pub const MRB_SYM__indices: c_int = 851;
pub const MRB_SYM__inspect: c_int = 852;
pub const MRB_SYM__ip_port: c_int = 853;
pub const MRB_SYM__keep_if: c_int = 854;
pub const MRB_SYM__keyrest: c_int = 855;
pub const MRB_SYM_Q__lambda: c_int = 856;
pub const MRB_SYM_B__lstrip: c_int = 857;
pub const MRB_SYM__mapping: c_int = 858;
pub const MRB_SYM__max_cmp: c_int = 859;
pub const MRB_SYM_Q__member: c_int = 860;
pub const MRB_SYM__members: c_int = 861;
pub const MRB_SYM__message: c_int = 862;
pub const MRB_SYM__methods: c_int = 863;
pub const MRB_SYM__min_cmp: c_int = 864;
pub const MRB_SYM__modules: c_int = 865;
pub const MRB_SYM_Q__monday: c_int = 866;
pub const MRB_SYM__nesting: c_int = 867;
pub const MRB_SYM__new_key: c_int = 868;
pub const MRB_SYM_Q__nobits: c_int = 869;
pub const MRB_SYM__numeric: c_int = 870;
pub const MRB_SYM__options: c_int = 871;
pub const MRB_SYM__optname: c_int = 872;
pub const MRB_SYM__pattern: c_int = 873;
pub const MRB_SYM__pfamily: c_int = 874;
pub const MRB_SYM__pointer: c_int = 875;
pub const MRB_SYM__prepend: c_int = 876;
pub const MRB_SYM__private: c_int = 877;
pub const MRB_SYM__produce: c_int = 878;
pub const MRB_SYM__product: c_int = 879;
pub const MRB_SYM_B__reject: c_int = 880;
pub const MRB_SYM__replace: c_int = 881;
pub const MRB_SYM_E__result: c_int = 882;
pub const MRB_SYM__reverse: c_int = 883;
pub const MRB_SYM_B__rotate: c_int = 884;
pub const MRB_SYM_B__rstrip: c_int = 885;
pub const MRB_SYM_B__select: c_int = 886;
pub const MRB_SYM__sep_len: c_int = 887;
pub const MRB_SYM__service: c_int = 888;
pub const MRB_SYM__serving: c_int = 889;
pub const MRB_SYM__setbyte: c_int = 890;
pub const MRB_SYM__shuffle: c_int = 891;
pub const MRB_SYM_Q__socket: c_int = 892;
pub const MRB_SYM__sort_by: c_int = 893;
pub const MRB_SYM__sprintf: c_int = 894;
pub const MRB_SYM__squeeze: c_int = 895;
pub const MRB_SYM__strings: c_int = 896;
pub const MRB_SYM_Q__subset: c_int = 897;
pub const MRB_SYM_Q__sunday: c_int = 898;
pub const MRB_SYM__symlink: c_int = 899;
pub const MRB_SYM__sysopen: c_int = 900;
pub const MRB_SYM__sysread: c_int = 901;
pub const MRB_SYM__sysseek: c_int = 902;
pub const MRB_SYM__to_enum: c_int = 903;
pub const MRB_SYM__to_hash: c_int = 904;
pub const MRB_SYM__to_proc: c_int = 905;
pub const MRB_SYM__tv_nsec: c_int = 906;
pub const MRB_SYM__unpack1: c_int = 907;
pub const MRB_SYM__unshift: c_int = 908;
pub const MRB_SYM_B__upcase: c_int = 909;
pub const MRB_SYM__yielder: c_int = 910;
pub const MRB_IVSYM__options: c_int = 911;
pub const MRB_SYM__AF_INET6: c_int = 912;
pub const MRB_SYM__AF_LOCAL: c_int = 913;
pub const MRB_SYM__AF_ROUTE: c_int = 914;
pub const MRB_SYM__Addrinfo: c_int = 915;
pub const MRB_SYM__EALREADY: c_int = 916;
pub const MRB_SYM__EBADARCH: c_int = 917;
pub const MRB_SYM__EBADEXEC: c_int = 918;
pub const MRB_SYM__ECAPMODE: c_int = 919;
pub const MRB_SYM__EL2NSYNC: c_int = 920;
pub const MRB_SYM__ELIBEXEC: c_int = 921;
pub const MRB_SYM__EMSGSIZE: c_int = 922;
pub const MRB_SYM__ENETDOWN: c_int = 923;
pub const MRB_SYM__ENOTCONN: c_int = 924;
pub const MRB_SYM__ENOTSOCK: c_int = 925;
pub const MRB_SYM__ENOTUNIQ: c_int = 926;
pub const MRB_SYM__EOFError: c_int = 927;
pub const MRB_SYM__EPROCLIM: c_int = 928;
pub const MRB_SYM__ERESTART: c_int = 929;
pub const MRB_SYM__ESTRPIPE: c_int = 930;
pub const MRB_SYM__FileTest: c_int = 931;
pub const MRB_SYM__INFINITY: c_int = 932;
pub const MRB_SYM__IPSocket: c_int = 933;
pub const MRB_SYM__KeyError: c_int = 934;
pub const MRB_SYM__MANT_DIG: c_int = 935;
pub const MRB_SYM__MSG_PEEK: c_int = 936;
pub const MRB_SYM__NI_DGRAM: c_int = 937;
pub const MRB_SYM__NOFOLLOW: c_int = 938;
pub const MRB_SYM__NONBLOCK: c_int = 939;
pub const MRB_SYM__NilClass: c_int = 940;
pub const MRB_SYM__PF_INET6: c_int = 941;
pub const MRB_SYM__PF_LOCAL: c_int = 942;
pub const MRB_SYM__PF_ROUTE: c_int = 943;
pub const MRB_SYM__Rational: c_int = 944;
pub const MRB_SYM__SEEK_CUR: c_int = 945;
pub const MRB_SYM__SEEK_END: c_int = 946;
pub const MRB_SYM__SEEK_SET: c_int = 947;
pub const MRB_SYM__SOCK_RAW: c_int = 948;
pub const MRB_SYM__SO_DEBUG: c_int = 949;
pub const MRB_SYM__SO_ERROR: c_int = 950;
pub const MRB_SYM__TCP_CORK: c_int = 951;
pub const MRB_SYM__TCP_INFO: c_int = 952;
pub const MRB_SYM__T_BIGINT: c_int = 953;
pub const MRB_SYM__T_ICLASS: c_int = 954;
pub const MRB_SYM__T_MODULE: c_int = 955;
pub const MRB_SYM__T_OBJECT: c_int = 956;
pub const MRB_SYM__T_SCLASS: c_int = 957;
pub const MRB_SYM__T_STRING: c_int = 958;
pub const MRB_SYM__T_STRUCT: c_int = 959;
pub const MRB_SYM____delete: c_int = 960;
pub const MRB_SYM____except: c_int = 961;
pub const MRB_SYM____send__: c_int = 962;
pub const MRB_SYM____svalue: c_int = 963;
pub const MRB_SYM____to_int: c_int = 964;
pub const MRB_SYM___accept2: c_int = 965;
pub const MRB_SYM___connect: c_int = 966;
pub const MRB_SYM_Q__allbits: c_int = 967;
pub const MRB_SYM__allocate: c_int = 968;
pub const MRB_SYM_Q__anybits: c_int = 969;
pub const MRB_SYM__basename: c_int = 970;
pub const MRB_SYM__began_at: c_int = 971;
pub const MRB_SYM_Q__between: c_int = 972;
pub const MRB_SYM__bytesize: c_int = 973;
pub const MRB_SYM_Q__casecmp: c_int = 974;
pub const MRB_SYM__children: c_int = 975;
pub const MRB_SYM__classify: c_int = 976;
pub const MRB_SYM_B__collect: c_int = 977;
pub const MRB_SYM_B__compact: c_int = 978;
pub const MRB_SYM_E__default: c_int = 979;
pub const MRB_SYM__downcase: c_int = 980;
pub const MRB_SYM__dropping: c_int = 981;
pub const MRB_SYM__each_key: c_int = 982;
pub const MRB_SYM__enum_for: c_int = 983;
pub const MRB_SYM__extended: c_int = 984;
pub const MRB_SYM__fallback: c_int = 985;
pub const MRB_SYM__find_all: c_int = 986;
pub const MRB_SYM__flat_map: c_int = 987;
pub const MRB_SYM_B__flatten: c_int = 988;
pub const MRB_SYM__get_path: c_int = 989;
pub const MRB_SYM__getlocal: c_int = 990;
pub const MRB_SYM__group_by: c_int = 991;
pub const MRB_SYM_Q__has_key: c_int = 992;
pub const MRB_SYM_Q__include: c_int = 993;
pub const MRB_SYM__included: c_int = 994;
pub const MRB_SYM_Q__integer: c_int = 995;
pub const MRB_SYM_Q__kind_of: c_int = 996;
pub const MRB_SYM__new_args: c_int = 997;
pub const MRB_SYM__nodename: c_int = 998;
pub const MRB_SYM_Q__nonzero: c_int = 999;
pub const MRB_SYM_Q__overlap: c_int = 1000;
pub const MRB_SYM__peeraddr: c_int = 1001;
pub const MRB_SYM__protocol: c_int = 1002;
pub const MRB_SYM__readbyte: c_int = 1003;
pub const MRB_SYM__readchar: c_int = 1004;
pub const MRB_SYM__readline: c_int = 1005;
pub const MRB_SYM__readlink: c_int = 1006;
pub const MRB_SYM__realpath: c_int = 1007;
pub const MRB_SYM__receiver: c_int = 1008;
pub const MRB_SYM__recvfrom: c_int = 1009;
pub const MRB_SYM__register: c_int = 1010;
pub const MRB_SYM_B__reverse: c_int = 1011;
pub const MRB_SYM__self_end: c_int = 1012;
pub const MRB_SYM__self_len: c_int = 1013;
pub const MRB_SYM__servname: c_int = 1014;
pub const MRB_SYM_B__shuffle: c_int = 1015;
pub const MRB_SYM__shutdown: c_int = 1016;
pub const MRB_SYM__sockaddr: c_int = 1017;
pub const MRB_SYM__socktype: c_int = 1018;
pub const MRB_SYM_B__sort_by: c_int = 1019;
pub const MRB_SYM_B__squeeze: c_int = 1020;
pub const MRB_SYM__str_each: c_int = 1021;
pub const MRB_SYM__subtract: c_int = 1022;
pub const MRB_SYM__swapcase: c_int = 1023;
pub const MRB_SYM_Q__symlink: c_int = 1024;
pub const MRB_SYM__syswrite: c_int = 1025;
pub const MRB_SYM__transfer: c_int = 1026;
pub const MRB_SYM__truncate: c_int = 1027;
pub const MRB_SYM_Q__tuesday: c_int = 1028;
pub const MRB_IVSYM__handlers: c_int = 1029;
pub const MRB_IVSYM__hostname: c_int = 1030;
pub const MRB_IVSYM__protocol: c_int = 1031;
pub const MRB_IVSYM__sockaddr: c_int = 1032;
pub const MRB_IVSYM__socktype: c_int = 1033;
pub const MRB_IVSYM__stop_exc: c_int = 1034;
pub const MRB_SYM__AF_UNSPEC: c_int = 1035;
pub const MRB_SYM__Constants: c_int = 1036;
pub const MRB_SYM__EBADMACHO: c_int = 1037;
pub const MRB_SYM__ECANCELED: c_int = 1038;
pub const MRB_SYM__EDEADLOCK: c_int = 1039;
pub const MRB_SYM__EHOSTDOWN: c_int = 1040;
pub const MRB_SYM__EMULTIHOP: c_int = 1041;
pub const MRB_SYM__ENEEDAUTH: c_int = 1042;
pub const MRB_SYM__ENETRESET: c_int = 1043;
pub const MRB_SYM__ENOMEDIUM: c_int = 1044;
pub const MRB_SYM__ENOPOLICY: c_int = 1045;
pub const MRB_SYM__ENOTEMPTY: c_int = 1046;
pub const MRB_SYM__EOVERFLOW: c_int = 1047;
pub const MRB_SYM__EREMOTEIO: c_int = 1048;
pub const MRB_SYM__ESHUTDOWN: c_int = 1049;
pub const MRB_SYM__ETIMEDOUT: c_int = 1050;
pub const MRB_SYM__Exception: c_int = 1051;
pub const MRB_SYM__FileError: c_int = 1052;
pub const MRB_SYM__Generator: c_int = 1053;
pub const MRB_SYM__HTTP_HOST: c_int = 1054;
pub const MRB_SYM__IP_MINTTL: c_int = 1055;
pub const MRB_SYM__MSG_TRUNC: c_int = 1056;
pub const MRB_SYM__NI_NOFQDN: c_int = 1057;
pub const MRB_SYM__NULL_BYTE: c_int = 1058;
pub const MRB_SYM__NameError: c_int = 1059;
pub const MRB_SYM__PATH_INFO: c_int = 1060;
pub const MRB_SYM__PF_UNSPEC: c_int = 1061;
pub const MRB_SYM__SEPARATOR: c_int = 1062;
pub const MRB_SYM__SHUT_RDWR: c_int = 1063;
pub const MRB_SYM__SO_LINGER: c_int = 1064;
pub const MRB_SYM__SO_RCVBUF: c_int = 1065;
pub const MRB_SYM__SO_SNDBUF: c_int = 1066;
pub const MRB_SYM__TCPServer: c_int = 1067;
pub const MRB_SYM__TCPSocket: c_int = 1068;
pub const MRB_SYM__T_COMPLEX: c_int = 1069;
pub const MRB_SYM__T_INTEGER: c_int = 1070;
pub const MRB_SYM__T_ISTRUCT: c_int = 1071;
pub const MRB_SYM__TrueClass: c_int = 1072;
pub const MRB_SYM__TypeError: c_int = 1073;
pub const MRB_SYM__UDPSocket: c_int = 1074;
pub const MRB_SYM____compact: c_int = 1075;
pub const MRB_SYM____outer__: c_int = 1076;
pub const MRB_SYM___allocate: c_int = 1077;
pub const MRB_SYM___gc_root_: c_int = 1078;
pub const MRB_SYM___recvfrom: c_int = 1079;
pub const MRB_SYM___sys_fail: c_int = 1080;
pub const MRB_SYM___sysclose: c_int = 1081;
pub const MRB_SYM___to_array: c_int = 1082;
pub const MRB_SYM__ancestors: c_int = 1083;
pub const MRB_SYM__backtrace: c_int = 1084;
pub const MRB_SYM__bind_call: c_int = 1085;
pub const MRB_SYM__build_app: c_int = 1086;
pub const MRB_SYM__byteindex: c_int = 1087;
pub const MRB_SYM__byteslice: c_int = 1088;
pub const MRB_SYM_Q__can_read: c_int = 1089;
pub const MRB_SYM__conjugate: c_int = 1090;
pub const MRB_SYM__const_get: c_int = 1091;
pub const MRB_SYM__const_set: c_int = 1092;
pub const MRB_SYM__constants: c_int = 1093;
pub const MRB_SYM__delete_at: c_int = 1094;
pub const MRB_SYM__delete_if: c_int = 1095;
pub const MRB_SYM_Q__disjoint: c_int = 1096;
pub const MRB_SYM_B__downcase: c_int = 1097;
pub const MRB_SYM__each_byte: c_int = 1098;
pub const MRB_SYM__each_char: c_int = 1099;
pub const MRB_SYM__each_cons: c_int = 1100;
pub const MRB_SYM__each_line: c_int = 1101;
pub const MRB_SYM__each_pair: c_int = 1102;
pub const MRB_SYM_Q__end_with: c_int = 1103;
pub const MRB_SYM__exception: c_int = 1104;
pub const MRB_SYM__exclusive: c_int = 1105;
pub const MRB_SYM__exit_code: c_int = 1106;
pub const MRB_SYM__feedvalue: c_int = 1107;
pub const MRB_SYM__imaginary: c_int = 1108;
pub const MRB_SYM_Q__infinite: c_int = 1109;
pub const MRB_SYM__inherited: c_int = 1110;
pub const MRB_SYM__ip_unpack: c_int = 1111;
pub const MRB_SYM_Q__iterator: c_int = 1112;
pub const MRB_SYM__localtime: c_int = 1113;
pub const MRB_SYM__magnitude: c_int = 1114;
pub const MRB_SYM__mime_type: c_int = 1115;
pub const MRB_SYM__minmax_by: c_int = 1116;
pub const MRB_SYM_Q__mismatch: c_int = 1117;
pub const MRB_SYM_Q__negative: c_int = 1118;
pub const MRB_SYM__numerator: c_int = 1119;
pub const MRB_SYM__object_id: c_int = 1120;
pub const MRB_SYM__other_end: c_int = 1121;
pub const MRB_SYM__partition: c_int = 1122;
pub const MRB_SYM__path_info: c_int = 1123;
pub const MRB_SYM_Q__positive: c_int = 1124;
pub const MRB_SYM__prepended: c_int = 1125;
pub const MRB_SYM__protected: c_int = 1126;
pub const MRB_SYM__readlines: c_int = 1127;
pub const MRB_SYM__remainder: c_int = 1128;
pub const MRB_SYM__satisfied: c_int = 1129;
pub const MRB_SYM_Q__saturday: c_int = 1130;
pub const MRB_SYM__self_excl: c_int = 1131;
pub const MRB_SYM__separator: c_int = 1132;
pub const MRB_SYM_Q__superset: c_int = 1133;
pub const MRB_SYM_B__swapcase: c_int = 1134;
pub const MRB_SYM__sysaccept: c_int = 1135;
pub const MRB_SYM_Q__thursday: c_int = 1136;
pub const MRB_SYM__transpose: c_int = 1137;
pub const MRB_SYM__ungetbyte: c_int = 1138;
pub const MRB_SYM__unix_path: c_int = 1139;
pub const MRB_SYM__values_at: c_int = 1140;
pub const MRB_IVSYM__feedvalue: c_int = 1141;
pub const MRB_IVSYM__lookahead: c_int = 1142;
pub const MRB_SYM__AI_PASSIVE: c_int = 1143;
pub const MRB_SYM__CatchError: c_int = 1144;
pub const MRB_SYM__Comparable: c_int = 1145;
pub const MRB_SYM__Dispatcher: c_int = 1146;
pub const MRB_SYM__EADDRINUSE: c_int = 1147;
pub const MRB_SYM__ECONNRESET: c_int = 1148;
pub const MRB_SYM__EINTEGRITY: c_int = 1149;
pub const MRB_SYM__EOPNOTSUPP: c_int = 1150;
pub const MRB_SYM__EOWNERDEAD: c_int = 1151;
pub const MRB_SYM__EPROTOTYPE: c_int = 1152;
pub const MRB_SYM__ESHLIBVERS: c_int = 1153;
pub const MRB_SYM__Enumerable: c_int = 1154;
pub const MRB_SYM__Enumerator: c_int = 1155;
pub const MRB_SYM__FalseClass: c_int = 1156;
pub const MRB_SYM__FiberError: c_int = 1157;
pub const MRB_SYM__IPPROTO_AH: c_int = 1158;
pub const MRB_SYM__IPPROTO_IP: c_int = 1159;
pub const MRB_SYM__IP_HDRINCL: c_int = 1160;
pub const MRB_SYM__IP_OPTIONS: c_int = 1161;
pub const MRB_SYM__IP_PASSSEC: c_int = 1162;
pub const MRB_SYM__IP_PKTINFO: c_int = 1163;
pub const MRB_SYM__IP_RECVERR: c_int = 1164;
pub const MRB_SYM__IP_RECVTOS: c_int = 1165;
pub const MRB_SYM__IP_RECVTTL: c_int = 1166;
pub const MRB_SYM__IP_RETOPTS: c_int = 1167;
pub const MRB_SYM__IndexError: c_int = 1168;
pub const MRB_SYM__MAX_10_EXP: c_int = 1169;
pub const MRB_SYM__MIME_TYPES: c_int = 1170;
pub const MRB_SYM__MIN_10_EXP: c_int = 1171;
pub const MRB_SYM__MSG_CTRUNC: c_int = 1172;
pub const MRB_SYM__NI_MAXHOST: c_int = 1173;
pub const MRB_SYM__NI_MAXSERV: c_int = 1174;
pub const MRB_SYM__RangeError: c_int = 1175;
pub const MRB_SYM__SOCK_DGRAM: c_int = 1176;
pub const MRB_SYM__SOL_SOCKET: c_int = 1177;
pub const MRB_SYM__TCP_MAXSEG: c_int = 1178;
pub const MRB_SYM__TCP_MD5SIG: c_int = 1179;
pub const MRB_SYM__TCP_SYNCNT: c_int = 1180;
pub const MRB_SYM__T_RATIONAL: c_int = 1181;
pub const MRB_SYM__UNIXServer: c_int = 1182;
pub const MRB_SYM__UNIXSocket: c_int = 1183;
pub const MRB_SYM____callee__: c_int = 1184;
pub const MRB_SYM____case_eqq: c_int = 1185;
pub const MRB_SYM____method__: c_int = 1186;
pub const MRB_SYM____num_to_a: c_int = 1187;
pub const MRB_SYM____subtract: c_int = 1188;
pub const MRB_SYM___separator: c_int = 1189;
pub const MRB_SYM__bit_length: c_int = 1190;
pub const MRB_SYM__byterindex: c_int = 1191;
pub const MRB_SYM__bytesplice: c_int = 1192;
pub const MRB_SYM_Q__can_serve: c_int = 1193;
pub const MRB_SYM__capitalize: c_int = 1194;
pub const MRB_SYM__class_eval: c_int = 1195;
pub const MRB_SYM__class_exec: c_int = 1196;
pub const MRB_SYM__codepoints: c_int = 1197;
pub const MRB_SYM__delete_all: c_int = 1198;
pub const MRB_SYM__difference: c_int = 1199;
pub const MRB_SYM_Q__directory: c_int = 1200;
pub const MRB_SYM__drop_while: c_int = 1201;
pub const MRB_SYM__each_child: c_int = 1202;
pub const MRB_SYM__each_entry: c_int = 1203;
pub const MRB_SYM__each_index: c_int = 1204;
pub const MRB_SYM__each_slice: c_int = 1205;
pub const MRB_SYM__each_value: c_int = 1206;
pub const MRB_SYM__fd_or_path: c_int = 1207;
pub const MRB_SYM__filter_map: c_int = 1208;
pub const MRB_SYM__find_index: c_int = 1209;
pub const MRB_SYM__getaddress: c_int = 1210;
pub const MRB_SYM__getpeereid: c_int = 1211;
pub const MRB_SYM__getsockopt: c_int = 1212;
pub const MRB_SYM__given_args: c_int = 1213;
pub const MRB_SYM__gmt_offset: c_int = 1214;
pub const MRB_SYM_Q__has_value: c_int = 1215;
pub const MRB_SYM__initialize: c_int = 1216;
pub const MRB_SYM_Q__intersect: c_int = 1217;
pub const MRB_SYM__ip_address: c_int = 1218;
pub const MRB_SYM__last_value: c_int = 1219;
pub const MRB_SYM__local_host: c_int = 1220;
pub const MRB_SYM__make_curry: c_int = 1221;
pub const MRB_SYM__middleware: c_int = 1222;
pub const MRB_SYM__other_excl: c_int = 1223;
pub const MRB_SYM__parameters: c_int = 1224;
pub const MRB_SYM__read_asset: c_int = 1225;
pub const MRB_SYM__rpartition: c_int = 1226;
pub const MRB_SYM__self_arity: c_int = 1227;
pub const MRB_SYM__self_begin: c_int = 1228;
pub const MRB_SYM__setsockopt: c_int = 1229;
pub const MRB_SYM__socketpair: c_int = 1230;
pub const MRB_SYM__step_ratio: c_int = 1231;
pub const MRB_SYM__subclasses: c_int = 1232;
pub const MRB_SYM__superclass: c_int = 1233;
pub const MRB_SYM__take_while: c_int = 1234;
pub const MRB_SYM__utc_offset: c_int = 1235;
pub const MRB_SYM_Q__wednesday: c_int = 1236;
pub const MRB_SYM__with_index: c_int = 1237;
pub const MRB_SYM__yield_self: c_int = 1238;
pub const MRB_IVSYM__middleware: c_int = 1239;
pub const MRB_SYM__BasicObject: c_int = 1240;
pub const MRB_SYM__BasicSocket: c_int = 1241;
pub const MRB_SYM__ContentType: c_int = 1242;
pub const MRB_SYM__DomainError: c_int = 1243;
pub const MRB_SYM__EINPROGRESS: c_int = 1244;
pub const MRB_SYM__EKEYEXPIRED: c_int = 1245;
pub const MRB_SYM__EKEYREVOKED: c_int = 1246;
pub const MRB_SYM__EMEDIUMTYPE: c_int = 1247;
pub const MRB_SYM__ENETUNREACH: c_int = 1248;
pub const MRB_SYM__ENOPROTOOPT: c_int = 1249;
pub const MRB_SYM__ENOTCAPABLE: c_int = 1250;
pub const MRB_SYM__EWOULDBLOCK: c_int = 1251;
pub const MRB_SYM__FNM_SYSCASE: c_int = 1252;
pub const MRB_SYM__FrozenError: c_int = 1253;
pub const MRB_SYM__IPPROTO_ESP: c_int = 1254;
pub const MRB_SYM__IPPROTO_RAW: c_int = 1255;
pub const MRB_SYM__IPPROTO_TCP: c_int = 1256;
pub const MRB_SYM__IPPROTO_UDP: c_int = 1257;
pub const MRB_SYM__IPV6_V6ONLY: c_int = 1258;
pub const MRB_SYM__IP_FREEBIND: c_int = 1259;
pub const MRB_SYM__IP_MSFILTER: c_int = 1260;
pub const MRB_SYM__IP_RECVOPTS: c_int = 1261;
pub const MRB_SYM__MSG_WAITALL: c_int = 1262;
pub const MRB_SYM__NI_NAMEREQD: c_int = 1263;
pub const MRB_SYM__ObjectSpace: c_int = 1264;
pub const MRB_SYM__QueryParser: c_int = 1265;
pub const MRB_SYM__RUBY_ENGINE: c_int = 1266;
pub const MRB_SYM__RegexpError: c_int = 1267;
pub const MRB_SYM__SCRIPT_NAME: c_int = 1268;
pub const MRB_SYM__SERVER_ADDR: c_int = 1269;
pub const MRB_SYM__SERVER_NAME: c_int = 1270;
pub const MRB_SYM__SERVER_PORT: c_int = 1271;
pub const MRB_SYM__SHELF_INPUT: c_int = 1272;
pub const MRB_SYM__SOCK_STREAM: c_int = 1273;
pub const MRB_SYM__SO_PEERCRED: c_int = 1274;
pub const MRB_SYM__SO_RCVLOWAT: c_int = 1275;
pub const MRB_SYM__SO_RCVTIMEO: c_int = 1276;
pub const MRB_SYM__SO_SNDLOWAT: c_int = 1277;
pub const MRB_SYM__SO_SNDTIMEO: c_int = 1278;
pub const MRB_SYM__ScriptError: c_int = 1279;
pub const MRB_SYM__SocketError: c_int = 1280;
pub const MRB_SYM__SyntaxError: c_int = 1281;
pub const MRB_SYM__TCP_KEEPCNT: c_int = 1282;
pub const MRB_SYM__TCP_LINGER2: c_int = 1283;
pub const MRB_SYM__TCP_NODELAY: c_int = 1284;
pub const MRB_SYM__T_EXCEPTION: c_int = 1285;
pub const MRB_SYM____fill_exec: c_int = 1286;
pub const MRB_SYM____members__: c_int = 1287;
pub const MRB_SYM_E___is_socket: c_int = 1288;
pub const MRB_SYM_Q__ascii_only: c_int = 1289;
pub const MRB_SYM__attr_reader: c_int = 1290;
pub const MRB_SYM__attr_writer: c_int = 1291;
pub const MRB_SYM_B__capitalize: c_int = 1292;
pub const MRB_SYM__chunk_while: c_int = 1293;
pub const MRB_SYM__close_write: c_int = 1294;
pub const MRB_SYM__combination: c_int = 1295;
pub const MRB_SYM__const_added: c_int = 1296;
pub const MRB_SYM__deconstruct: c_int = 1297;
pub const MRB_SYM__default_app: c_int = 1298;
pub const MRB_SYM__denominator: c_int = 1299;
pub const MRB_SYM__each_object: c_int = 1300;
pub const MRB_SYM__environment: c_int = 1301;
pub const MRB_SYM__expand_path: c_int = 1302;
pub const MRB_SYM__getaddrinfo: c_int = 1303;
pub const MRB_SYM__gethostname: c_int = 1304;
pub const MRB_SYM__getnameinfo: c_int = 1305;
pub const MRB_SYM__getpeername: c_int = 1306;
pub const MRB_SYM__getsockname: c_int = 1307;
pub const MRB_SYM__message_get: c_int = 1308;
pub const MRB_SYM__method_code: c_int = 1309;
pub const MRB_SYM__method_name: c_int = 1310;
pub const MRB_SYM__module_eval: c_int = 1311;
pub const MRB_SYM__module_exec: c_int = 1312;
pub const MRB_SYM__next_values: c_int = 1313;
pub const MRB_SYM__other_begin: c_int = 1314;
pub const MRB_SYM__parse_query: c_int = 1315;
pub const MRB_SYM__peek_values: c_int = 1316;
pub const MRB_SYM__permutation: c_int = 1317;
pub const MRB_SYM_Q__production: c_int = 1318;
pub const MRB_SYM__public_send: c_int = 1319;
pub const MRB_SYM__rectangular: c_int = 1320;
pub const MRB_SYM_Q__respond_to: c_int = 1321;
pub const MRB_SYM_Q__route_file: c_int = 1322;
pub const MRB_SYM__sockaddr_in: c_int = 1323;
pub const MRB_SYM__sockaddr_un: c_int = 1324;
pub const MRB_SYM_Q__start_with: c_int = 1325;
pub const MRB_SYM_E__step_ratio: c_int = 1326;
pub const MRB_SYM__to_sockaddr: c_int = 1327;
pub const MRB_SYM_Q__valid_path: c_int = 1328;
pub const MRB_SYM__with_object: c_int = 1329;
pub const MRB_SYM__AI_CANONNAME: c_int = 1330;
pub const MRB_SYM__ALLOW_HEADER: c_int = 1331;
pub const MRB_SYM__CONTENT_TYPE: c_int = 1332;
pub const MRB_SYM__CommonLogger: c_int = 1333;
pub const MRB_SYM__EAFNOSUPPORT: c_int = 1334;
pub const MRB_SYM__ECONNABORTED: c_int = 1335;
pub const MRB_SYM__ECONNREFUSED: c_int = 1336;
pub const MRB_SYM__EDESTADDRREQ: c_int = 1337;
pub const MRB_SYM__EHOSTUNREACH: c_int = 1338;
pub const MRB_SYM__EKEYREJECTED: c_int = 1339;
pub const MRB_SYM__ENAMETOOLONG: c_int = 1340;
pub const MRB_SYM__EPFNOSUPPORT: c_int = 1341;
pub const MRB_SYM__EPROCUNAVAIL: c_int = 1342;
pub const MRB_SYM__EPROGUNAVAIL: c_int = 1343;
pub const MRB_SYM__ERPCMISMATCH: c_int = 1344;
pub const MRB_SYM__ETOOMANYREFS: c_int = 1345;
pub const MRB_SYM__FNM_CASEFOLD: c_int = 1346;
pub const MRB_SYM__FNM_DOTMATCH: c_int = 1347;
pub const MRB_SYM__FNM_NOESCAPE: c_int = 1348;
pub const MRB_SYM__FNM_PATHNAME: c_int = 1349;
pub const MRB_SYM__HTTP_VERSION: c_int = 1350;
pub const MRB_SYM__IPPROTO_ICMP: c_int = 1351;
pub const MRB_SYM__IPPROTO_IPV6: c_int = 1352;
pub const MRB_SYM__IPPROTO_NONE: c_int = 1353;
pub const MRB_SYM__MSG_DONTWAIT: c_int = 1354;
pub const MRB_SYM__MSG_NOSIGNAL: c_int = 1355;
pub const MRB_SYM__QUERY_STRING: c_int = 1356;
pub const MRB_SYM__REQUEST_PATH: c_int = 1357;
pub const MRB_SYM__RUBY_VERSION: c_int = 1358;
pub const MRB_SYM__RuntimeError: c_int = 1359;
pub const MRB_SYM__SHARE_DELETE: c_int = 1360;
pub const MRB_SYM__SHELF_ERRORS: c_int = 1361;
pub const MRB_SYM__SHELF_LOGGER: c_int = 1362;
pub const MRB_SYM__SO_BROADCAST: c_int = 1363;
pub const MRB_SYM__SO_DONTROUTE: c_int = 1364;
pub const MRB_SYM__SO_KEEPALIVE: c_int = 1365;
pub const MRB_SYM__SO_OOBINLINE: c_int = 1366;
pub const MRB_SYM__SO_REUSEADDR: c_int = 1367;
pub const MRB_SYM__SO_REUSEPORT: c_int = 1368;
pub const MRB_SYM__SO_TIMESTAMP: c_int = 1369;
pub const MRB_SYM__TCP_KEEPIDLE: c_int = 1370;
pub const MRB_SYM__TCP_QUICKACK: c_int = 1371;
pub const MRB_SYM____ENCODING__: c_int = 1372;
pub const MRB_SYM____attached__: c_int = 1373;
pub const MRB_SYM____codepoints: c_int = 1374;
pub const MRB_SYM____difference: c_int = 1375;
pub const MRB_SYM____errno_list: c_int = 1376;
pub const MRB_SYM____pat_values: c_int = 1377;
pub const MRB_SYM___setnonblock: c_int = 1378;
pub const MRB_SYM___sockaddr_in: c_int = 1379;
pub const MRB_SYM__alias_method: c_int = 1380;
pub const MRB_SYM_Q__block_given: c_int = 1381;
pub const MRB_SYM__column_count: c_int = 1382;
pub const MRB_SYM__column_index: c_int = 1383;
pub const MRB_SYM__content_type: c_int = 1384;
pub const MRB_SYM__default_host: c_int = 1385;
pub const MRB_SYM__default_proc: c_int = 1386;
pub const MRB_SYM_Q__exclude_end: c_int = 1387;
pub const MRB_SYM__fetch_values: c_int = 1388;
pub const MRB_SYM__generate_map: c_int = 1389;
pub const MRB_SYM_Q__include_all: c_int = 1390;
pub const MRB_SYM_Q__include_any: c_int = 1391;
pub const MRB_SYM_Q__instance_of: c_int = 1392;
pub const MRB_SYM__intersection: c_int = 1393;
pub const MRB_SYM__keyword_init: c_int = 1394;
pub const MRB_SYM__method_added: c_int = 1395;
pub const MRB_SYM__mruby_Random: c_int = 1396;
pub const MRB_SYM__remove_const: c_int = 1397;
pub const MRB_SYM__reverse_each: c_int = 1398;
pub const MRB_SYM__super_method: c_int = 1399;
pub const MRB_SYM__undef_method: c_int = 1400;
pub const MRB_IVSYM__content_type: c_int = 1401;
pub const MRB_IVSYM__init_with_fd: c_int = 1402;
pub const MRB_SYM__ALLOWED_VERBS: c_int = 1403;
pub const MRB_SYM__ALT_SEPARATOR: c_int = 1404;
pub const MRB_SYM__ArgumentError: c_int = 1405;
pub const MRB_SYM__ContentLength: c_int = 1406;
pub const MRB_SYM__EADDRNOTAVAIL: c_int = 1407;
pub const MRB_SYM__EPROGMISMATCH: c_int = 1408;
pub const MRB_SYM__IP_PKTOPTIONS: c_int = 1409;
pub const MRB_SYM__MRUBY_VERSION: c_int = 1410;
pub const MRB_SYM__MSG_DONTROUTE: c_int = 1411;
pub const MRB_SYM__NoMemoryError: c_int = 1412;
pub const MRB_SYM__NoMethodError: c_int = 1413;
pub const MRB_SYM__SHELF_R3_DATA: c_int = 1414;
pub const MRB_SYM__StandardError: c_int = 1415;
pub const MRB_SYM__StopIteration: c_int = 1416;
pub const MRB_SYM__TCP_KEEPINTVL: c_int = 1417;
pub const MRB_SYM__UnboundMethod: c_int = 1418;
pub const MRB_SYM____classname__: c_int = 1419;
pub const MRB_SYM____sub_replace: c_int = 1420;
pub const MRB_SYM____update_hash: c_int = 1421;
pub const MRB_SYM__absolute_path: c_int = 1422;
pub const MRB_SYM__attr_accessor: c_int = 1423;
pub const MRB_SYM__bsearch_index: c_int = 1424;
pub const MRB_SYM__const_missing: c_int = 1425;
pub const MRB_SYM__count_objects: c_int = 1426;
pub const MRB_SYM_E__default_proc: c_int = 1427;
pub const MRB_SYM__define_method: c_int = 1428;
pub const MRB_SYM__delete_prefix: c_int = 1429;
pub const MRB_SYM__delete_suffix: c_int = 1430;
pub const MRB_SYM__in_lower_half: c_int = 1431;
pub const MRB_SYM__instance_eval: c_int = 1432;
pub const MRB_SYM__instance_exec: c_int = 1433;
pub const MRB_SYM__local_address: c_int = 1434;
pub const MRB_SYM__local_service: c_int = 1435;
pub const MRB_SYM__recv_nonblock: c_int = 1436;
pub const MRB_SYM__remove_method: c_int = 1437;
pub const MRB_SYM__set_backtrace: c_int = 1438;
pub const MRB_SYM__AI_NUMERICHOST: c_int = 1439;
pub const MRB_SYM__AI_NUMERICSERV: c_int = 1440;
pub const MRB_SYM__CONTENT_LENGTH: c_int = 1441;
pub const MRB_SYM__IPPROTO_ICMPV6: c_int = 1442;
pub const MRB_SYM__IP_ORIGDSTADDR: c_int = 1443;
pub const MRB_SYM__IP_PMTUDISC_DO: c_int = 1444;
pub const MRB_SYM__IP_RECVRETOPTS: c_int = 1445;
pub const MRB_SYM__IP_TRANSPARENT: c_int = 1446;
pub const MRB_SYM__IP_XFRM_POLICY: c_int = 1447;
pub const MRB_SYM__LocalJumpError: c_int = 1448;
pub const MRB_SYM__MCAST_MSFILTER: c_int = 1449;
pub const MRB_SYM__NI_NUMERICHOST: c_int = 1450;
pub const MRB_SYM__NI_NUMERICSERV: c_int = 1451;
pub const MRB_SYM__PATH_SEPARATOR: c_int = 1452;
pub const MRB_SYM__REQUEST_METHOD: c_int = 1453;
pub const MRB_SYM__SOCK_SEQPACKET: c_int = 1454;
pub const MRB_SYM__TCP_CONGESTION: c_int = 1455;
pub const MRB_SYM____do_with_enum: c_int = 1456;
pub const MRB_SYM_Q____empty_range: c_int = 1457;
pub const MRB_SYM____errno_define: c_int = 1458;
pub const MRB_SYM____intersection: c_int = 1459;
pub const MRB_SYM____upto_endless: c_int = 1460;
pub const MRB_SYM_Q__absolute_path: c_int = 1461;
pub const MRB_SYM_E__close_on_exec: c_int = 1462;
pub const MRB_SYM_Q__close_on_exec: c_int = 1463;
pub const MRB_SYM__collect_concat: c_int = 1464;
pub const MRB_SYM_Q__const_defined: c_int = 1465;
pub const MRB_SYM_B__delete_prefix: c_int = 1466;
pub const MRB_SYM_B__delete_suffix: c_int = 1467;
pub const MRB_SYM__dump_exception: c_int = 1468;
pub const MRB_SYM__each_codepoint: c_int = 1469;
pub const MRB_SYM__interval_ratio: c_int = 1470;
pub const MRB_SYM__method_missing: c_int = 1471;
pub const MRB_SYM__method_removed: c_int = 1472;
pub const MRB_SYM__paragraph_mode: c_int = 1473;
pub const MRB_SYM__path_not_found: c_int = 1474;
pub const MRB_SYM_Q__proper_subset: c_int = 1475;
pub const MRB_SYM__public_methods: c_int = 1476;
pub const MRB_SYM__remote_address: c_int = 1477;
pub const MRB_SYM__transform_keys: c_int = 1478;
pub const MRB_SYM__ENOTRECOVERABLE: c_int = 1479;
pub const MRB_SYM__EPROTONOSUPPORT: c_int = 1480;
pub const MRB_SYM__ESOCKTNOSUPPORT: c_int = 1481;
pub const MRB_SYM__IPPROTO_DSTOPTS: c_int = 1482;
pub const MRB_SYM__IPPROTO_ROUTING: c_int = 1483;
pub const MRB_SYM__IPV6_JOIN_GROUP: c_int = 1484;
pub const MRB_SYM__IP_BLOCK_SOURCE: c_int = 1485;
pub const MRB_SYM__IP_IPSEC_POLICY: c_int = 1486;
pub const MRB_SYM__IP_MTU_DISCOVER: c_int = 1487;
pub const MRB_SYM__IP_MULTICAST_IF: c_int = 1488;
pub const MRB_SYM__IP_ROUTER_ALERT: c_int = 1489;
pub const MRB_SYM__MRUBY_COPYRIGHT: c_int = 1490;
pub const MRB_SYM__SERVER_PROTOCOL: c_int = 1491;
pub const MRB_SYM__SO_INCOMING_CPU: c_int = 1492;
pub const MRB_SYM__SystemCallError: c_int = 1493;
pub const MRB_SYM____product_group: c_int = 1494;
pub const MRB_SYM__accept_nonblock: c_int = 1495;
pub const MRB_SYM_Q__add_index_root: c_int = 1496;
pub const MRB_SYM__append_as_bytes: c_int = 1497;
pub const MRB_SYM__attached_object: c_int = 1498;
pub const MRB_SYM__class_variables: c_int = 1499;
pub const MRB_SYM__clean_path_info: c_int = 1500;
pub const MRB_SYM__default_options: c_int = 1501;
pub const MRB_SYM__each_with_index: c_int = 1502;
pub const MRB_SYM__format_datetime: c_int = 1503;
pub const MRB_SYM__initialize_copy: c_int = 1504;
pub const MRB_SYM__instance_method: c_int = 1505;
pub const MRB_SYM_E__interval_ratio: c_int = 1506;
pub const MRB_SYM__local_variables: c_int = 1507;
pub const MRB_SYM_Q__method_defined: c_int = 1508;
pub const MRB_SYM__module_function: c_int = 1509;
pub const MRB_SYM__private_methods: c_int = 1510;
pub const MRB_SYM__singleton_class: c_int = 1511;
pub const MRB_SYM__source_location: c_int = 1512;
pub const MRB_SYM_B__transform_keys: c_int = 1513;
pub const MRB_SYM__FloatDomainError: c_int = 1514;
pub const MRB_SYM__IPPROTO_FRAGMENT: c_int = 1515;
pub const MRB_SYM__IPV6_LEAVE_GROUP: c_int = 1516;
pub const MRB_SYM__IP_MULTICAST_ALL: c_int = 1517;
pub const MRB_SYM__IP_MULTICAST_TTL: c_int = 1518;
pub const MRB_SYM__IP_PMTUDISC_DONT: c_int = 1519;
pub const MRB_SYM__IP_PMTUDISC_WANT: c_int = 1520;
pub const MRB_SYM__MCAST_JOIN_GROUP: c_int = 1521;
pub const MRB_SYM__MRUBY_RELEASE_NO: c_int = 1522;
pub const MRB_SYM__SHELF_URL_SCHEME: c_int = 1523;
pub const MRB_SYM__SimpleHttpServer: c_int = 1524;
pub const MRB_SYM__SystemStackError: c_int = 1525;
pub const MRB_SYM__TCP_DEFER_ACCEPT: c_int = 1526;
pub const MRB_SYM__TCP_WINDOW_CLAMP: c_int = 1527;
pub const MRB_SYM_Q____errno_defined: c_int = 1528;
pub const MRB_SYM____fill_parse_arg: c_int = 1529;
pub const MRB_SYM___sockaddr_family: c_int = 1530;
pub const MRB_SYM__connect_nonblock: c_int = 1531;
pub const MRB_SYM__deconstruct_keys: c_int = 1532;
pub const MRB_SYM__each_with_object: c_int = 1533;
pub const MRB_SYM__exception_string: c_int = 1534;
pub const MRB_SYM__global_variables: c_int = 1535;
pub const MRB_SYM__included_modules: c_int = 1536;
pub const MRB_SYM__inspect_sockaddr: c_int = 1537;
pub const MRB_SYM__instance_methods: c_int = 1538;
pub const MRB_SYM__method_and_route: c_int = 1539;
pub const MRB_SYM__method_undefined: c_int = 1540;
pub const MRB_SYM__normalized_index: c_int = 1541;
pub const MRB_SYM__pack_sockaddr_in: c_int = 1542;
pub const MRB_SYM__pack_sockaddr_un: c_int = 1543;
pub const MRB_SYM_Q__proper_superset: c_int = 1544;
pub const MRB_SYM_Q__singleton_class: c_int = 1545;
pub const MRB_SYM__singleton_method: c_int = 1546;
pub const MRB_SYM__transform_values: c_int = 1547;
pub const MRB_IVSYM____keyword_init__: c_int = 1548;
pub const MRB_SYM__HTTP_STATUS_CODES: c_int = 1549;
pub const MRB_SYM__IPV6_MULTICAST_IF: c_int = 1550;
pub const MRB_SYM__IPV6_UNICAST_HOPS: c_int = 1551;
pub const MRB_SYM__IP_ADD_MEMBERSHIP: c_int = 1552;
pub const MRB_SYM__IP_MULTICAST_LOOP: c_int = 1553;
pub const MRB_SYM__IP_PMTUDISC_PROBE: c_int = 1554;
pub const MRB_SYM__IP_UNBLOCK_SOURCE: c_int = 1555;
pub const MRB_SYM__MCAST_LEAVE_GROUP: c_int = 1556;
pub const MRB_SYM__MRUBY_DESCRIPTION: c_int = 1557;
pub const MRB_SYM__ZeroDivisionError: c_int = 1558;
pub const MRB_SYM____normalize_index: c_int = 1559;
pub const MRB_SYM__generational_mode: c_int = 1560;
pub const MRB_SYM__protected_methods: c_int = 1561;
pub const MRB_SYM__recvfrom_nonblock: c_int = 1562;
pub const MRB_SYM__singleton_methods: c_int = 1563;
pub const MRB_SYM_B__transform_values: c_int = 1564;
pub const MRB_SYM__IP_DROP_MEMBERSHIP: c_int = 1565;
pub const MRB_SYM__IP_RECVORIGDSTADDR: c_int = 1566;
pub const MRB_SYM__MCAST_BLOCK_SOURCE: c_int = 1567;
pub const MRB_SYM__MRUBY_RELEASE_DATE: c_int = 1568;
pub const MRB_SYM__UncaughtThrowError: c_int = 1569;
pub const MRB_SYM____combination_init: c_int = 1570;
pub const MRB_SYM____combination_next: c_int = 1571;
pub const MRB_SYM__class_variable_get: c_int = 1572;
pub const MRB_SYM__class_variable_set: c_int = 1573;
pub const MRB_SYM_E__generational_mode: c_int = 1574;
pub const MRB_SYM__instance_variables: c_int = 1575;
pub const MRB_SYM__local_variable_get: c_int = 1576;
pub const MRB_SYM__local_variable_set: c_int = 1577;
pub const MRB_SYM__logging_middleware: c_int = 1578;
pub const MRB_SYM__method_not_allowed: c_int = 1579;
pub const MRB_SYM__unpack_sockaddr_in: c_int = 1580;
pub const MRB_SYM__unpack_sockaddr_un: c_int = 1581;
pub const MRB_SYM__IPV6_MULTICAST_HOPS: c_int = 1582;
pub const MRB_SYM__IPV6_MULTICAST_LOOP: c_int = 1583;
pub const MRB_SYM__NotImplementedError: c_int = 1584;
pub const MRB_SYM__RUBY_ENGINE_VERSION: c_int = 1585;
pub const MRB_SYM__SO_INCOMING_NAPI_ID: c_int = 1586;
pub const MRB_SYM_Q____method_recursive: c_int = 1587;
pub const MRB_SYM_Q__respond_to_missing: c_int = 1588;
pub const MRB_SYM__MCAST_UNBLOCK_SOURCE: c_int = 1589;
pub const MRB_SYM_Q__overwrite_file_path: c_int = 1590;
pub const MRB_SYM__repeated_combination: c_int = 1591;
pub const MRB_SYM__repeated_permutation: c_int = 1592;
pub const MRB_SYM____coerce_step_counter: c_int = 1593;
pub const MRB_SYM__do_not_reverse_lookup: c_int = 1594;
pub const MRB_SYM__instance_variable_get: c_int = 1595;
pub const MRB_SYM__instance_variable_set: c_int = 1596;
pub const MRB_SYM__remove_class_variable: c_int = 1597;
pub const MRB_IVSYM__do_not_reverse_lookup: c_int = 1598;
pub const MRB_SYM__NoMatchingPatternError: c_int = 1599;
pub const MRB_SYM____repeated_combination: c_int = 1600;
pub const MRB_SYM_E__do_not_reverse_lookup: c_int = 1601;
pub const MRB_SYM__extract_content_length: c_int = 1602;
pub const MRB_SYM__singleton_method_added: c_int = 1603;
pub const MRB_CVSYM__do_not_reverse_lookup: c_int = 1604;
pub const MRB_SYM__MCAST_JOIN_SOURCE_GROUP: c_int = 1605;
pub const MRB_SYM__SHELF_REQUEST_FORM_HASH: c_int = 1606;
pub const MRB_SYM__SHELF_REQUEST_FORM_VARS: c_int = 1607;
pub const MRB_SYM____enumerator_block_call: c_int = 1608;
pub const MRB_SYM_Q__class_variable_defined: c_int = 1609;
pub const MRB_SYM__define_singleton_method: c_int = 1610;
pub const MRB_SYM__last_modified_timestamp: c_int = 1611;
pub const MRB_SYM_Q__local_variable_defined: c_int = 1612;
pub const MRB_SYM__public_instance_methods: c_int = 1613;
pub const MRB_SYM__IP_ADD_SOURCE_MEMBERSHIP: c_int = 1614;
pub const MRB_SYM__MCAST_LEAVE_SOURCE_GROUP: c_int = 1615;
pub const MRB_SYM__SHELF_REQUEST_QUERY_HASH: c_int = 1616;
pub const MRB_SYM__private_instance_methods: c_int = 1617;
pub const MRB_SYM__remove_instance_variable: c_int = 1618;
pub const MRB_SYM__singleton_method_removed: c_int = 1619;
pub const MRB_SYM__IP_DROP_SOURCE_MEMBERSHIP: c_int = 1620;
pub const MRB_SYM__store_query_hash_into_env: c_int = 1621;
pub const MRB_SYM__STATUS_WITH_NO_ENTITY_BODY: c_int = 1622;
pub const MRB_SYM_Q__instance_variable_defined: c_int = 1623;
pub const MRB_SYM__protected_instance_methods: c_int = 1624;
pub const MRB_SYM__singleton_method_undefined: c_int = 1625;
pub const MRB_SYM__undefined_instance_methods: c_int = 1626;
pub const MRB_SYM__write_exception_to_shelf_errors: c_int = 1627;
...
// mruby-4.0.0-rc2/build/host/include/mruby/compile.h:30:12: warning: struct demoted to opaque type - has bitfield
...
pub const struct_parser_lex_strterm_15 = opaque {};
// mruby-4.0.0-rc2/build/host/include/mruby/compile.h:108:12: warning: struct demoted to opaque type - has bitfield
...
// mruby-4.0.0-rc2/build/host/include/mruby/common.h:44:10
pub const mrb_deprecated = @compileError("unable to translate macro: undefined identifier `deprecated`");
// mruby-4.0.0-rc2/build/host/include/mruby/common.h:55:10
pub inline fn mrb_likely(x: anytype) @TypeOf(__builtin_expect(!!(x != 0), @as(c_int, 1))) {
    _ = &x;
    return __builtin_expect(!!(x != 0), @as(c_int, 1));
}
pub inline fn mrb_unlikely(x: anytype) @TypeOf(__builtin_expect(!!(x != 0), @as(c_int, 0))) {
    _ = &x;
...
// mruby-4.0.0-rc2/build/host/include/mruby/common.h:78:11
pub const MRB_INLINE = @compileError("unable to translate C expr: unexpected token 'static'");
// mruby-4.0.0-rc2/build/host/include/mruby/common.h:97:9
pub const MRB_API = @compileError("unable to translate C expr: unexpected token 'extern'");
// mruby-4.0.0-rc2/build/host/include/mruby/common.h:108:10
...
pub const MRB_FLAGS_SET = @compileError("unable to translate C expr: expected ')' instead got '='");
// mruby-4.0.0-rc2/build/host/include/mruby/value.h:99:9
...
pub const MRB_FLAG_ON = @compileError("unable to translate C expr: expected ')' instead got '|='");
// mruby-4.0.0-rc2/build/host/include/mruby/value.h:102:9
pub const MRB_FLAG_OFF = @compileError("unable to translate C expr: expected ')' instead got '&='");
// mruby-4.0.0-rc2/build/host/include/mruby/value.h:103:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/value.h:170:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/value.h:179:9
pub const MRB_VTYPE_TYPEDEF = @compileError("unable to translate C expr: unexpected token 'typedef'");
// mruby-4.0.0-rc2/build/host/include/mruby/value.h:181:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/object.h:10:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/object.h:47:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/boxing_word.h:200:9
pub const mrb_integer_p = @compileError("unable to translate macro: undefined identifier `FIXNUM`");
// mruby-4.0.0-rc2/build/host/include/mruby/boxing_word.h:201:9
pub const mrb_symbol_p = @compileError("unable to translate macro: undefined identifier `SYMBOL`");
// mruby-4.0.0-rc2/build/host/include/mruby/boxing_word.h:202:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/version.h:20:9
...
pub const MRUBY_PATCHLEVEL_STR = "RC2";
...
pub const MRUBY_RELEASE_DAY = @as(c_int, 12);
...
pub inline fn MRB_ARGS_NOBLOCK() mrb_aspec {
    return @import("std").zig.c_translation.cast(mrb_aspec, @as(c_int, 1) << @as(c_int, 23));
}
...
// mruby-4.0.0-rc2/build/host/include/mruby.h:1098:9
...
// mruby-4.0.0-rc2/build/host/include/mruby.h:1224:9
...
// mruby-4.0.0-rc2/build/host/include/mruby.h:1249:9
pub const mrb_utf8_free = @compileError("unable to translate C expr: unexpected token ''");
// mruby-4.0.0-rc2/build/host/include/mruby.h:1250:9
...
// mruby-4.0.0-rc2/build/host/include/mruby.h:1581:9
...
pub const MRB_PRESYM_MAX = @as(c_int, 1627);
pub const MRB_OPSYM = @compileError("unable to translate macro: undefined identifier `MRB_OPSYM__`");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:35:9
pub const MRB_GVSYM = @compileError("unable to translate macro: undefined identifier `MRB_GVSYM__`");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:36:9
pub const MRB_CVSYM = @compileError("unable to translate macro: undefined identifier `MRB_CVSYM__`");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:37:9
pub const MRB_IVSYM = @compileError("unable to translate macro: undefined identifier `MRB_IVSYM__`");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:38:9
pub const MRB_SYM_B = @compileError("unable to translate macro: undefined identifier `MRB_SYM_B__`");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:39:9
pub const MRB_SYM_Q = @compileError("unable to translate macro: undefined identifier `MRB_SYM_Q__`");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:40:9
pub const MRB_SYM_E = @compileError("unable to translate macro: undefined identifier `MRB_SYM_E__`");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:41:9
pub const MRB_SYM = @compileError("unable to translate macro: undefined identifier `MRB_SYM__`");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:42:9
...
pub const MRB_PRESYM_DEFINE_VAR_AND_INITER = @compileError("unable to translate C expr: expected ')' instead got '...'");
// mruby-4.0.0-rc2/build/host/include/mruby/presym.h:54:9
pub inline fn MRB_PRESYM_INIT_SYMBOLS(mrb: anytype, name: anytype) anyopaque {
    _ = &mrb;
    _ = &name;
    return @import("std").zig.c_translation.cast(anyopaque, mrb);
}
...
pub const MRB_UNIQNAME = @compileError("unable to translate macro: undefined identifier `__LINE__`");
// mruby-4.0.0-rc2/build/host/include/mruby.h:1630:9
pub inline fn MRB_UNIQNAME_1(name: anytype, line: anytype) @TypeOf(MRB_UNIQNAME_2(name, line)) {
    _ = &name;
    _ = &line;
    return MRB_UNIQNAME_2(name, line);
}
pub const MRB_UNIQNAME_2 = @compileError("unable to translate C expr: unexpected token '##'");
// mruby-4.0.0-rc2/build/host/include/mruby.h:1632:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/array.h:64:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/array.h:66:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/array.h:74:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/array.h:85:9
pub const ARY_UNSET_SHARED_FLAG = @compileError("unable to translate C expr: expected ')' instead got '&='");
// mruby-4.0.0-rc2/build/host/include/mruby/array.h:86:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/proc.h:34:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/proc.h:36:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/proc.h:39:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/proc.h:88:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/proc.h:126:9
pub const MRB_METHOD_FROM_PROC = @compileError("unable to translate C expr: unexpected token 'do'");
// mruby-4.0.0-rc2/build/host/include/mruby/proc.h:127:9
...
pub const MRB_SET_VISIBILITY_FLAGS = @compileError("unable to translate C expr: expected ')' instead got '='");
// mruby-4.0.0-rc2/build/host/include/mruby/proc.h:132:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/string.h:41:9
...
// mruby-4.0.0-rc2/build/host/include/mruby/string.h:122:9
